...
var Collapse_Collapse = /*#__PURE__*/function (_React$Component) {
  ...
  function Collapse() {
    ...
    _this.handleExit = function (elem) {
      var dimension = _this.getDimension(); // TODO: TS hack :(


      var get = _this.props.getDimensionValue || getDimensionValue;
  ...
  _proto.getDimension = function getDimension() {
    return typeof this.props.dimension === 'function' ? this.props.dimension() : this.props.dimension || 'height';
  }
  /* -- Expanding -- */
  ;
  ...
  _proto.render = function render() {
    ...
    return (
      /*#__PURE__*/
      // @ts-ignore
      external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(esm_Transition, _extends({
  ...
  return Collapse;
}(external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Component); // @ts-ignore


Collapse_Collapse.propTypes = Collapse_propTypes; // @ts-ignore
...
function usePopper(referenceElement, popperElement, _temp) {
  ...
  Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useEffect"])(function () {
    ...
    popperInstanceRef.current = popper_createPopper(referenceElement, popperElement, _extends({}, popperOptions, {
      placement: placement,
      strategy: strategy,
      modifiers: [].concat(modifiers, [updateModifier])
    }));
...
function useDropdownMenu(options) {
  ...
  var popper = esm_usePopper(toggleElement, menuElement, _extends({}, popperConfig, {
    placement: placement,
...
var Modal_Modal = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.forwardRef(function (_ref, ref) {
  ...
  var ignoreBackdropClickRef = Object(external_root_React_commonjs2_react_commonjs_react_amd_react_["useRef"])(false); // TODO: what's this type
...
var Overlay = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.forwardRef(function (props, outerRef) {
  ...
  var _usePopper = esm_usePopper(target, rootElement, _extends({}, popperConfig, {
