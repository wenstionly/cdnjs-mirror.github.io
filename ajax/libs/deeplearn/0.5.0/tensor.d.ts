...
export declare class Tensor<R extends Rank = Rank> {
    ...
    depthwiseConv2D<T extends Tensor3D | Tensor4D>(this: T, filter: Tensor4D, strides: [number, number] | number, pad: 'valid' | 'same' | number, rates?: [number, number] | number, dimRoundingMode?: 'floor' | 'round' | 'ceil'): T;
