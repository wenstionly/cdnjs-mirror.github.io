...
export declare class Ops {
    ...
    static depthwiseConv2d<T extends Tensor3D | Tensor4D>(input: T, filter: Tensor4D, strides: [number, number] | number, pad: 'valid' | 'same' | number, rates?: [number, number] | number, dimRoundingMode?: 'floor' | 'round' | 'ceil'): T;
}
