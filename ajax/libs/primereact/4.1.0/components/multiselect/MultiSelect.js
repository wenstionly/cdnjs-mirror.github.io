...
function (_Component) {
  ...
  _createClass(MultiSelect, [{
    ...
    value: function filterOptions(options) {
      ...
      return _ObjectUtils.default.filter(options, searchFields, filterValue, this.props.filterMatchMode);
    }
  }, {
    key: "getOptionLabel",
    value: function getOptionLabel(option) {
      return this.props.optionLabel ? _ObjectUtils.default.resolveFieldData(option, this.props.optionLabel) : option.label || option;
    }
  }, {
    key: "getOptionValue",
    value: function getOptionValue(option) {
      return this.props.optionValue ? _ObjectUtils.default.resolveFieldData(option, this.props.optionValue) : option.value || option;
    }
  }, {
    key: "isEmpty",
          ...
          if (this.props.value.length <= this.props.maxSelectedLabels) {
            return this.props.value.map(function (val, index) {
              return _react.default.createElement(_react.default.Fragment, {
                key: index
              }, _this4.props.selectedItemTemplate(val));
            });
          } else {
            return this.getSelectedItemsLabel();
          }
      ...
      if (items) {
        ...
        items = items.map(function (option, index) {
          ...
          return _react.default.createElement(_MultiSelectItem.MultiSelectItem, {
            ...
            selected: _this5.isSelected(option),
            onClick: _this5.onOptionClick,
            onKeyDown: _this5.onOptionKeyDown,
