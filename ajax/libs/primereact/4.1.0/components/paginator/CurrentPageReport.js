...
function (_Component) {
  ...
  _createClass(CurrentPageReport, [{
    ...
    value: function render() {
      var text = this.props.template.replace("{currentPage}", this.props.page + 1).replace("{totalPages}", this.props.pageCount).replace("{first}", this.props.first + 1).replace("{last}", this.props.first + this.props.rows).replace("{rows}", this.props.rows).replace("{totalRecords}", this.props.totalRecords);
