...
(function(root) {
    ...
    function scrypt(password, salt, N, r, p, dkLen, callback) {
        ...
        if (N === 0 || (N & (N - 1)) !== 0) { throw new Error('invalid parameter N (must be power of 2)'); }

        if (N > MAX_VALUE / 128 / r) { throw new Error('invalid parameter N (too large)'); }
        if (r > MAX_VALUE / 128 / p) { throw new Error('invalid parameter r (too large)'); }
