  ...
  return function o(s, u, i) {
    function c(t, e) {
      ...
      var h = e("github-calendar-parser"),
        ...
        b = y(b), (m = m || {}).summary_text = m.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", m.cache = 1e3 * (m.cache || 86400), !1 === m.global_stats && (b.style.minHeight = "175px");var r = "gh_calendar_content",
            n = "gh_calendar_expire";m.proxy = m.proxy || function (e) {
          return fetch("https://api.bloggify.net/gh-calendar/?username=" + e).then(function (e) {
            return e.text();
          });
        }, m.getCalendar = m.getCalendar || function (e) {
          if (m.cache && Date.now() < +localStorage.getItem(n)) {
            var t = localStorage.getItem(r);if (t) return Promise.resolve(t);
          }return m.proxy(e).then(function (e) {
            return m.cache && (localStorage.setItem(r, e), localStorage.setItem(n, Date.now() + m.cache)), e;
          });
        };return function g() {
