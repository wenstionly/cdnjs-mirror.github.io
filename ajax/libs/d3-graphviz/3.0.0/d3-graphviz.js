(function (global, factory) {
	...
	(factory((global['d3-graphviz'] = {}),global.d3,global.d3,global.d3,global.d3,global.d3,global.d3,global['@hpcc-js/wasm'],global.d3,global.d3));
}(this, (function (exports,d3,d3Dispatch,d3Transition,d3Timer,d3Interpolate,d3Zoom,_hpccJs_wasm,d3Format,d3Path) { 'use strict';
...
function initViz() {
    ...
    if (this._worker == null) {
        _hpccJs_wasm.graphviz.layout("", "svg", "dot").then(function () {
            _hpccJs_wasm.graphvizSync().then(function (graphviz1) {
        ...
        this._worker.onmessage = function (event$$1) {
            ...
            switch (event$$1.data.type) {
                case "init":
                    ...
                    break;
                case "done":
                    return layoutDone.call(graphvizInstance, event$$1.data.svg, callback);
                case "error":
...
function graphviz$1(selector, options$$1) {
    var g = d3.select(selector).graphviz(options$$1);
    return g;
}

Graphviz.prototype = graphviz$1.prototype = (_graphviz$prototype = {
