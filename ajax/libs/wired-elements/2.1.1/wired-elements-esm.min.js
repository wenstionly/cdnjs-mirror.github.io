...
`;class ae extends se{constructor(){super(...arguments),this.lastSize=[0,0],this.seed=Math.floor(Math.random()*2**31)}updated(e){this.wiredRender()}wiredRender(e=!1){if(this.svg){const t=this.canvasSize();if(!e&&t[0]===this.lastSize[0]&&t[1]===this.lastSize[1])return;for(;this.svg.hasChildNodes();)this.svg.removeChild(this.svg.lastChild);this.svg.setAttribute("width",""+t[0]),this.svg.setAttribute("height",""+t[1]),this.draw(this.svg,t),this.lastSize=t,this.classList.add("wired-rendered")}}}function le(e,t,i,s=!0,n=!0){if(t){const r={bubbles:"boolean"!=typeof s||s,composed:"boolean"!=typeof n||n};i&&(r.detail=i),e.dispatchEvent(new CustomEvent(t,r))}}function de(){return Math.floor(Math.random()*2**31)}function he(e,t,i){if(e&&e.length){const[s,n]=t,r=Math.PI/180*i,o=Math.cos(r),a=Math.sin(r);e.forEach(e=>{const[t,i]=e;e[0]=(t-s)*o-(i-n)*a+s,e[1]=(t-s)*a+(i-n)*o+n})}}function ce(e){const t=e[0],i=e[1];return Math.sqrt(Math.pow(t[0]-i[0],2)+Math.pow(t[1]-i[1],2))}function pe(e,t,i,s){const n=t[1]-e[1],r=e[0]-t[0],o=n*e[0]+r*e[1],a=s[1]-i[1],d=i[0]-s[0],l=a*i[0]+d*i[1],h=n*d-a*r;return h?[(d*o-r*l)/h,(n*l-a*o)/h]:null}function ue(e,t,i){const s=e.length;if(s<3)return!1;const n=[Number.MAX_SAFE_INTEGER,i],r=[t,i];let o=0;for(let t=0;t<s;t++){const i=e[t],a=e[(t+1)%s];if(ye(i,a,r,n)){if(0===ge(i,r,a))return fe(i,r,a);o++}}return o%2==1}function fe(e,t,i){return t[0]<=Math.max(e[0],i[0])&&t[0]>=Math.min(e[0],i[0])&&t[1]<=Math.max(e[1],i[1])&&t[1]>=Math.min(e[1],i[1])}function ge(e,t,i){const s=(t[1]-e[1])*(i[0]-t[0])-(t[0]-e[0])*(i[1]-t[1]);return 0===s?0:s>0?1:2}function ye(e,t,i,s){const n=ge(e,t,i),r=ge(e,t,s),o=ge(i,s,e),a=ge(i,s,t);return n!==r&&o!==a||!(0!==n||!fe(e,i,t))||!(0!==r||!fe(e,s,t))||!(0!==o||!fe(i,e,s))||!(0!==a||!fe(i,t,s))}function ve(e,t){const i=[0,0],s=Math.round(t.hachureAngle+90);s&&he(e,i,s);const n=function(e,t){const i=[...e];i[0].join(",")!==i[i.length-1].join(",")&&i.push([i[0][0],i[0][1]]);const s=[];if(i&&i.length>2){let e=t.hachureGap;e<0&&(e=4*t.strokeWidth),e=Math.max(e,.1);const n=[];for(let e=0;e<i.length-1;e++){const t=i[e],s=i[e+1];if(t[1]!==s[1]){const e=Math.min(t[1],s[1]);n.push({ymin:e,ymax:Math.max(t[1],s[1]),x:e===t[1]?t[0]:s[0],islope:(s[0]-t[0])/(s[1]-t[1])})}}if(n.sort((e,t)=>e.ymin<t.ymin?-1:e.ymin>t.ymin?1:e.x<t.x?-1:e.x>t.x?1:e.ymax===t.ymax?0:(e.ymax-t.ymax)/Math.abs(e.ymax-t.ymax)),!n.length)return s;let r=[],o=n[0].ymin;for(;r.length||n.length;){if(n.length){let e=-1;for(let t=0;t<n.length&&!(n[t].ymin>o);t++)e=t;n.splice(0,e+1).forEach(e=>{r.push({s:o,edge:e})})}if((r=r.filter(e=>!(e.edge.ymax<=o))).sort((e,t)=>e.edge.x===t.edge.x?0:(e.edge.x-t.edge.x)/Math.abs(e.edge.x-t.edge.x)),r.length>1)for(let e=0;e<r.length;e+=2){const t=e+1;if(t>=r.length)break;const i=r[e].edge,n=r[t].edge;s.push([[Math.round(i.x),o],[Math.round(n.x),o]])}o+=e,r.forEach(t=>{t.edge.x=t.edge.x+e*t.edge.islope})}}return s}(e,t);return s&&(he(e,i,-s),function(e,t,i){const s=[];n.forEach(e=>s.push(...e)),he(s,t,i)}(0,i,-s)),n}ne([G("svg"),oe("design:type",SVGSVGElement)],ae.prototype,"svg",void 0);class be extends class{constructor(e){this.helper=e}fillPolygon(e,t){return this._fillPolygon(e,t)}_fillPolygon(e,t,i=!1){let s=ve(e,t);if(i){const t=this.connectingLines(e,s);s=s.concat(t)}return{type:"fillSketch",ops:this.renderLines(s,t)}}renderLines(e,t){const i=[];for(const s of e)i.push(...this.helper.doubleLineOps(s[0][0],s[0][1],s[1][0],s[1][1],t));return i}connectingLines(e,t){const i=[];if(t.length>1)for(let s=1;s<t.length;s++){const n=t[s-1];if(ce(n)<3)continue;const r=[t[s][0],n[1]];if(ce(r)>3){const t=this.splitOnIntersections(e,r);i.push(...t)}}return i}midPointInPolygon(e,t){return ue(e,(t[0][0]+t[1][0])/2,(t[0][1]+t[1][1])/2)}splitOnIntersections(e,t){const i=Math.max(5,.1*ce(t)),s=[];for(let n=0;n<e.length;n++){const r=e[n],o=e[(n+1)%e.length];if(ye(r,o,...t)){const e=pe(r,o,t[0],t[1]);if(e){const n=ce([e,t[0]]),r=ce([e,t[1]]);n>i&&r>i&&s.push({point:e,distance:n})}}}if(s.length>1){const i=s.sort((e,t)=>e.distance-t.distance).map(e=>e.point);if(ue(e,...t[0])||i.shift(),ue(e,...t[1])||i.pop(),i.length<=1)return this.midPointInPolygon(e,t)?[t]:[];const n=[t[0],...i,t[1]],r=[];for(let t=0;t<n.length-1;t+=2){const i=[n[t],n[t+1]];this.midPointInPolygon(e,i)&&r.push(i)}return r}return this.midPointInPolygon(e,t)?[t]:[]}}{fillPolygon(e,t){return this._fillPolygon(e,t,!0)}}class me{constructor(e){this.seed=e}next(){return this.seed?(2**31-1&(this.seed=Math.imul(48271,this.seed)))/2**31:Math.random()}}function we(e,t,i,s,n){return{type:"path",ops:_e(e,t,i,s,n)}}function xe(e,t){return function(e,t,i){const s=(e||[]).length;if(s>2){const t=[];for(let n=0;n<s-1;n++)t.push(..._e(e[n][0],e[n][1],e[n+1][0],e[n+1][1],i));return t.push(..._e(e[s-1][0],e[s-1][1],e[0][0],e[0][1],i)),{type:"path",ops:t}}return 2===s?we(e[0][0],e[0][1],e[1][0],e[1][1],i):{type:"path",ops:[]}}(e,0,t)}function ke(e,t,i,s,n){return function(e,t,i,s){const[n,r]=Pe(s.increment,e,t,s.rx,s.ry,1,s.increment*Oe(.1,Oe(.4,1,i),i),i);let o=Me(n,null,i);if(!i.disableMultiStroke){const[n]=Pe(s.increment,e,t,s.rx,s.ry,1.5,0,i),r=Me(n,null,i);o=o.concat(r)}return{estimatedPoints:r,opset:{type:"path",ops:o}}}(e,t,n,Se(i,s,n)).opset}function Se(e,t,i){const s=Math.sqrt(2*Math.PI*Math.sqrt((Math.pow(e/2,2)+Math.pow(t/2,2))/2)),n=Math.max(i.curveStepCount,i.curveStepCount/Math.sqrt(200)*s),r=2*Math.PI/n;let o=Math.abs(e/2),a=Math.abs(t/2);const d=1-i.curveFitting;return{increment:r,rx:o+=ze(o*d,i),ry:a+=ze(a*d,i)}}function Re(e){return e.randomizer||(e.randomizer=new me(e.seed||0)),e.randomizer.next()}function Oe(e,t,i,s=1){return i.roughness*s*(Re(i)*(t-e)+e)}function ze(e,t,i=1){return Oe(-e,e,t,i)}function _e(e,t,i,s,n,r=!1){const o=r?n.disableMultiStrokeFill:n.disableMultiStroke,a=Ce(e,t,i,s,n,!0,!1);if(o)return a;const d=Ce(e,t,i,s,n,!0,!0);return a.concat(d)}function Ce(e,t,i,s,n,r,o){const a=Math.pow(e-i,2)+Math.pow(t-s,2),d=Math.sqrt(a);let l=1;l=d<200?1:d>500?.4:-.0016668*d+1.233334;let h=n.maxRandomnessOffset||0;h*h*100>a&&(h=d/10);const c=h/2,p=.2+.2*Re(n);let u=n.bowing*n.maxRandomnessOffset*(s-t)/200,f=n.bowing*n.maxRandomnessOffset*(e-i)/200;u=ze(u,n,l),f=ze(f,n,l);const g=[],y=()=>ze(c,n,l),v=()=>ze(h,n,l);return r&&(o?g.push({op:"move",data:[e+y(),t+y()]}):g.push({op:"move",data:[e+ze(h,n,l),t+ze(h,n,l)]})),o?g.push({op:"bcurveTo",data:[u+e+(i-e)*p+y(),f+t+(s-t)*p+y(),u+e+2*(i-e)*p+y(),f+t+2*(s-t)*p+y(),i+y(),s+y()]}):g.push({op:"bcurveTo",data:[u+e+(i-e)*p+v(),f+t+(s-t)*p+v(),u+e+2*(i-e)*p+v(),f+t+2*(s-t)*p+v(),i+v(),s+v()]}),g}function Me(e,t,i){const s=e.length,n=[];if(s>3){const r=[],o=1-i.curveTightness;n.push({op:"move",data:[e[1][0],e[1][1]]});for(let t=1;t+2<s;t++){const i=e[t];r[0]=[i[0],i[1]],r[1]=[i[0]+(o*e[t+1][0]-o*e[t-1][0])/6,i[1]+(o*e[t+1][1]-o*e[t-1][1])/6],r[2]=[e[t+1][0]+(o*e[t][0]-o*e[t+2][0])/6,e[t+1][1]+(o*e[t][1]-o*e[t+2][1])/6],r[3]=[e[t+1][0],e[t+1][1]],n.push({op:"bcurveTo",data:[r[1][0],r[1][1],r[2][0],r[2][1],r[3][0],r[3][1]]})}if(t&&2===t.length){const e=i.maxRandomnessOffset;n.push({op:"lineTo",data:[t[0]+ze(e,i),t[1]+ze(e,i)]})}}else 3===s?(n.push({op:"move",data:[e[1][0],e[1][1]]}),n.push({op:"bcurveTo",data:[e[1][0],e[1][1],e[2][0],e[2][1],e[2][0],e[2][1]]})):2===s&&n.push(..._e(e[0][0],e[0][1],e[1][0],e[1][1],i));return n}function Pe(e,t,i,s,n,r,o,a){const d=[],l=[],h=ze(.5,a)-Math.PI/2;l.push([ze(r,a)+t+.9*s*Math.cos(h-e),ze(r,a)+i+.9*n*Math.sin(h-e)]);for(let o=h;o<2*Math.PI+h-.01;o+=e){const e=[ze(r,a)+t+s*Math.cos(o),ze(r,a)+i+n*Math.sin(o)];d.push(e),l.push(e)}return l.push([ze(r,a)+t+s*Math.cos(h+2*Math.PI+.5*o),ze(r,a)+i+n*Math.sin(h+2*Math.PI+.5*o)]),l.push([ze(r,a)+t+.98*s*Math.cos(h+o),ze(r,a)+i+.98*n*Math.sin(h+o)]),l.push([ze(r,a)+t+.9*s*Math.cos(h+.5*o),ze(r,a)+i+.9*n*Math.sin(h+.5*o)]),[l,d]}const je={randOffset:(e,t)=>e,randOffsetWithRange:(e,t,i)=>(e+t)/2,ellipse:(e,t,i,s,n)=>ke(e,t,i,s,n),doubleLineOps:(e,t,i,s,n)=>(function(e,t,i,s,n){return _e(e,t,i,s,n,!0)})(e,t,i,s,n)};function $e(e){return{maxRandomnessOffset:2,roughness:1,bowing:.85,stroke:"#000",strokeWidth:1.5,curveTightness:0,curveFitting:.95,curveStepCount:9,fillStyle:"hachure",fillWeight:3.5,hachureAngle:-41,hachureGap:5,dashOffset:-1,dashGap:-1,zigzagOffset:0,combineNestedSvgPaths:!1,disableMultiStroke:!1,disableMultiStrokeFill:!1,seed:e}}function Ne(e,t){let i="";for(const s of e.ops){const e=s.data;switch(s.op){case"move":if(t&&i)break;i+=`M${e[0]} ${e[1]} `;break;case"bcurveTo":i+=`C${e[0]} ${e[1]}, ${e[2]} ${e[3]}, ${e[4]} ${e[5]} `;break;case"lineTo":i+=`L${e[0]} ${e[1]} `}}return i.trim()}function Ee(e,t){const i=document.createElementNS("http://www.w3.org/2000/svg",e);if(t)for(const e in t)i.setAttributeNS(null,e,t[e]);return i}function De(e,t,i=!1){const s=Ee("path",{d:Ne(e,i)});return t&&t.appendChild(s),s}function Ae(e,t,i,s,n,r){return De(function(e,t,i,s,n){return xe([[e,t],[e+i,t],[e+i,t+s],[e,t+s]],$e(r))}(t+2,i+2,s-4,n-4),e)}function Ie(e,t,i,s,n,r){return De(we(t,i,s,n,$e(r)),e)}function Le(e,t,i,s,n,r){return De(ke(t,i,s=Math.max(s>10?s-4:s-1,1),n=Math.max(n>10?n-4:n-1,1),$e(r)),e)}function Te(e,t){return De(new be(je).fillPolygon(e,$e(t)),null)}function Be(e,t,i,s,n){const r=Se(i,s,$e(n)),o=[];let a=0;for(;a<=2*Math.PI;)o.push([e+r.rx*Math.cos(a),t+r.ry*Math.sin(a)]),a+=r.increment;return Te(o,n)}var He=function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o},Ve=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Ue=class extends ae{constructor(){super(),this.elevation=1,this.disabled=!1,window.ResizeObserver&&(this.resizeObserver=new window.ResizeObserver(()=>{this.svg&&this.wiredRender(!0)}))}static get styles(){return[re,te`
        :host {
    ...
    `}getProgressLabel(){return this.percentage?this.max===this.min?"%":Math.floor((this.value-this.min)/(this.max-this.min)*100)+"%":""+this.value}wiredRender(e=!1){super.wiredRender(e),this.refreshProgressFill()}canvasSize(){const e=this.getBoundingClientRect();return[e.width,e.height]}draw(e,t){Ae(e,2,2,t[0]-2,t[1]-2,this.seed)}refreshProgressFill(){if(this.progBox&&(this.progBox.parentElement&&this.progBox.parentElement.removeChild(this.progBox),this.progBox=void 0),this.svg){let e=0;const t=this.getBoundingClientRect();if(this.max>this.min){e=(this.value-this.min)/(this.max-this.min);const i=t.width*Math.max(0,Math.min(e,100));this.progBox=Te([[0,0],[i,0],[i,t.height],[0,t.height]],this.seed),this.svg.appendChild(this.progBox),this.progBox.classList.add("progbox")}}}};Mt([J({type:Number}),Pt("design:type",Object)],jt.prototype,"value",void 0),Mt([J({type:Number}),Pt("design:type",Object)],jt.prototype,"min",void 0),Mt([J({type:Number}),Pt("design:type",Object)],jt.prototype,"max",void 0),Mt([J({type:Boolean}),Pt("design:type",Object)],jt.prototype,"percentage",void 0),jt=Mt([W("wired-progress")],jt);var $t=function(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o},Nt=function(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)};let Et=class extends ae{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.focused=!1}static get styles(){return[re,te`
      :host {
        display: inline-block;
        font-family: inherit;
      }
