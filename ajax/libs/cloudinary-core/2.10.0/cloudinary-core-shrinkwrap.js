/**
   * cloudinary-main.js
   * Cloudinary's JavaScript library - Version 2.10.0
...
_toConsumableArray(chars).forEach(function (_char) {
  var key = base64Map_num.toString(2).padStart(6, '0');
  map[key] = _char;
  base64Map_num++;
});
/**
...
function encodeVersion(semVer) {
  ...
  var paddedBinary = num.toString(2).padStart(paddedStringLength, '0'); // Stop in case an invalid version number was provided
