...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var P=!1;if("undefined"!=typeof window)try{var z=Object.defineProperty({},"passive",{get:function(){P=!0}});window.addEventListener("test",z,z),window.removeEventListener("test",z,z)}catch(e){P=!1}var O={useG:!0},j={},C={},I=new RegExp("^"+a+"(\\w+)(true|false)$"),x=u("propagationStopped");function N(e,t){var n=[];for(var r in e){var o=I.exec(r),i=o&&o[1];if(i&&(!t||i===t)){var a=e[r];if(a)for(var s=0;s<a.length;s++)n.push(a[s])}}return n}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
