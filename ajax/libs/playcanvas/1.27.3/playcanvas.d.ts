...
declare namespace pc {
    ...
    namespace callbacks {
        ...
        /**
         * Callback used by {@link pc.Application#loadSceneHierarchy}.
         * @param err - The error message in the case where the loading or parsing fails.
        ...
        /**
         * Callback used by {@link pc.Application#loadSceneSettings}.
         * @param err - The error message in the case where the loading or parsing fails.
         */
        type LoadSettings = (err: string | null) => void;
        /**
         * Callback used by {@link pc.Application#loadScene}.
         * @param err - The error message in the case where the loading or parsing fails.
         * @param [entity] - The loaded root entity if no errors were encountered.
         */
    ...
    * {@link pc.SPRITETYPE_ANIMATED}: The component can play sprite animation clips.
    ...
    class SceneRegistry {
         ...
         * @param callback - The function to call after loading, passed (err, entity) where err is null if no errors occurred.
         */
         ...
         * @param callback - The function called after the settings are applied. Passed (err) where err is null if no error occurred.
         */
         ...
         * @param url - The URL of the scene file.
         * @param callback - The function called after the settings are applied. Passed (err, scene) where err is null if no error occurred and scene is the pc.Scene.
         */
