...
(function () {
  ...
  out$.saveSvg = function (el, name, options) {
    return requireDomNodePromise(el).then(out$.svgAsDataUri(el, options || {})).then(function (uri) {
      return out$.download(name, uri);
    });
  };

  out$.saveSvgAsPng = function (el, name, options) {
    return requireDomNodePromise(el).then(out$.svgAsPngUri(el, options || {})).then(function (uri) {
      return out$.download(name, uri);
    });
  };
})();