...
var Transformer = (function (_super) {
    ...
    Transformer.prototype.__getNodeRect = function () {
        ...
        return rotateAroundPoint(box, Global_1.Konva.getAngle(this.rotation()), {
            x: 0,
            y: 0
        });
    };
    ...
    Transformer.prototype._fitNodeInto = function (node, newAttrs, evt) {
        ...
        var parentRot = Global_1.Konva.getAngle(node.getParent().getAbsoluteRotation());
        node.rotation(Util_1.Util._getRotation(newAttrs.rotation - parentRot));
...
},{"../core":67,"inline-worker":3}],64:[function(_dereq_,module,exports){
"use strict";
...
},{"./audiodecoder":63,"./options":64}],66:[function(_dereq_,module,exports){
"use strict";
...
},{"./adapters/arraybuffer":61,"./adapters/object":62,"./channel":66}],68:[function(_dereq_,module,exports){
"use strict";
...
},{"./lib/builders/webaudio":65,"./lib/core":67}],69:[function(_dereq_,module,exports){
...
},{"./cue":70,"./utils":88}],70:[function(_dereq_,module,exports){
...
},{"konva":43}],72:[function(_dereq_,module,exports){
module.exports = function (Konva) {
    'use strict';
...
},{"konva":43}],73:[function(_dereq_,module,exports){
...
},{"./cue-emitter":69,"./keyboard-handler":74,"./marker-factories":76,"./mediaelement-player":77,"./player":79,"./utils":88,"./view-controller":89,"./waveform-builder":91,"./waveform-points":93,"./waveform-segments":94,"./zoom-controller":97,"colors.css":1,"eventemitter3":2}],76:[function(_dereq_,module,exports){
...
},{"./default-point-marker":71,"./default-segment-marker":72,"konva":43}],77:[function(_dereq_,module,exports){
module.exports = function () {
    'use strict';
...
},{"konva":43}],81:[function(_dereq_,module,exports){
module.exports = function (Konva) {
    'use strict';
...
},{"./utils":88,"waveform-data":68}],92:[function(_dereq_,module,exports){
...
},{"./highlight-layer":73,"./mouse-drag-handler":78,"./playhead-layer":80,"./points-layer":83,"./segments-layer":87,"./utils":88,"./waveform-axis":90,"./waveform-shape":95,"konva":43}],93:[function(_dereq_,module,exports){
