...
var script = {
  name: 'BTabs',
  components: (_components = {}, __chunk_1._defineProperty(_components, __chunk_4.Icon.name, __chunk_4.Icon), __chunk_1._defineProperty(_components, __chunk_24.SlotComponent.name, __chunk_24.SlotComponent), _components),
  props: {
    value: Number,
    expanded: Boolean,
    type: String,
