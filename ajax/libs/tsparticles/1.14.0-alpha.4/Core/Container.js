...
var Container = (function () {
    ...
    Container.prototype.start = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var absorbers, loadAbsorbers, emitters, loadEmitters, _i, _a, plugin, _b, _c, type, type, _d, _e, _f, type, drawer;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        emitters = this.options.emitters;
                        loadEmitters = false;
                        ...
                        if (loadEmitters) {
                            this.plugins.push(new Emitters_1.Emitters(this));
                        }
                        this.started = true;
