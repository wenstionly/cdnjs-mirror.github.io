...
class CanvasUtils_CanvasUtils {
  ...
  static drawParticle(container, context, particle, colorValue, backgroundMask, radius, opacity, shadow) {
    const pos = {
  ...
  static drawShape(container, context, particle, radius, opacity) {
    if (!particle.shape) {
      return;
    }
  ...
  static drawShapeAfterEffect(container, context, particle, radius, opacity) {
    if (!particle.shape) {
      return;
    }
  ...
  static drawPlugin(context, plugin) {
    context.save();
...
class Canvas_Canvas {
  ...
  drawParticle(particle) {
    ...
    const infectionRgb = infectionColor ? ColorUtils_ColorUtils.colorToRgb(infectionColor) : undefined;
    ...
    CanvasUtils_CanvasUtils.drawParticle(this.container, this.context, particle, colorValue, options.backgroundMask.enable, radius, opacity, particle.particlesOptions.shadow);
  }
  ...
  drawPlugin(plugin) {
    ...
    CanvasUtils_CanvasUtils.drawPlugin(this.context, plugin);
  }
...
class SimplexNoise {
  constructor(random) {
    ...
    this.p = SimplexNoise.buildPermutationTable(random);
    ...
    if (particlesOptions.move.enable) {
      ...
      if (noiseEnabled) {
        ...
        if (particle.lastNoiseTime > particle.noiseDelay) {
          ...
          const noise = {
            angle: simplex.noise3D(Math.floor(position.x / particle.size.value) / noiseFactor.horizontal.value + noiseFactor.horizontal.offset, Math.floor(position.y / particle.size.value) / noiseFactor.horizontal.value + noiseFactor.horizontal.offset, container.particles.noiseZ),
            length: simplex.noise3D(Math.floor(position.x / particle.size.value) / noiseFactor.vertical.value + noiseFactor.vertical.offset, Math.floor(position.y / particle.size.value) / noiseFactor.vertical.value + noiseFactor.vertical.offset, container.particles.noiseZ)
          };
...
// CONCATENATED MODULE: ./dist/Options/Classes/Particles/OptionsColor.js
class OptionsColor {
  constructor() {
    this.value = "#fff";
  }
        ...
        if (item !== undefined) {
          if (item instanceof Array) {
            if (this.options[ShapeType.image] instanceof Array) {
              this.options[ShapeType.image] = Utils_Utils.deepExtend((_l = this.options[ShapeType.image]) !== null && _l !== void 0 ? _l : [], item);
              this.options[ShapeType.images] = Utils_Utils.deepExtend((_m = this.options[ShapeType.images]) !== null && _m !== void 0 ? _m : [], item);
            } else {
              this.options[ShapeType.image] = Utils_Utils.deepExtend([], item);
              this.options[ShapeType.images] = Utils_Utils.deepExtend([], item);
            }
          } else {
            if (this.options[ShapeType.image] instanceof Array) {
              this.options[ShapeType.image] = Utils_Utils.deepExtend({}, item);
              ...
              this.options[ShapeType.image] = Utils_Utils.deepExtend((_o = this.options[ShapeType.image]) !== null && _o !== void 0 ? _o : [], item);
              this.options[ShapeType.images] = Utils_Utils.deepExtend((_p = this.options[ShapeType.images]) !== null && _p !== void 0 ? _p : [], item);
            }
          }
        }
      }
...
// CONCATENATED MODULE: ./dist/Enums/StartValueType.js
var StartValueType;
...
// CONCATENATED MODULE: ./dist/Enums/DestroyType.js
var DestroyType;
...
class Particle_Particle {
  constructor(container, position, emitter) {
    ...
    if (((_b = (_a = emitter === null || emitter === void 0 ? void 0 : emitter.emitterOptions) === null || _a === void 0 ? void 0 : _a.particles) === null || _b === void 0 ? void 0 : _b.shape) !== undefined) {
      const shapeType = (_c = emitter.emitterOptions.particles.shape.type) !== null && _c !== void 0 ? _c : particlesOptions.shape.type;
    ...
    if (!drawer) {
      drawer = CanvasUtils_CanvasUtils.getShapeDrawer(this.shape);
...
class Rectangle extends Range {
  ...
  intersects(range) {
    return !(range.position.x - range.size.width > this.position.x + this.size.width || range.position.x + range.size.width < this.position.x - this.size.width || range.position.y - range.size.height > this.position.y + this.size.height || range.position.y + range.size.height < this.position.y - this.size.height);
  }
...
class Linker_Linker {
  static link(p1, container) {
    ...
    for (const p2 of query) {
      ...
      const distance = Utils_Utils.getDistanceBetweenCoordinates(pos1, pos2);
...
class Infecter_Infecter {
  static infect(p1, container) {
    ...
    const query = container.particles.quadTree.query(new Circle(pos.x, pos.y, radius)).filter(t => t.infectionStage === undefined || t.infectionStage !== p1.infectionStage);
...
class InteractionManager_InteractionManager {
  static interact(p1, container) {
    ...
    if (p1.particlesOptions.move.attract.enable) {
      Attractor_Attractor.attract(p1, container);
    }
    ...
    if (container.options.infection.enable) {
      Infecter_Infecter.infect(p1, container);
    }
  }
  ...
  static grab(container) {
    ...
    if (interactivity.events.onHover.enable && container.interactivity.status === Constants.mouseMoveEvent) {
      ...
      for (const particle of query) {
        ...
        const distance = Utils_Utils.getDistanceBetweenCoordinates(pos, mousePos);
...
class Core_Particles_Particles {
  ...
  update(delta) {
    ...
    if (Utils_Utils.isInArray(HoverMode.connect, hoverMode)) {
      Connector_Connector.connect(container);
    }
...
// CONCATENATED MODULE: ./dist/Plugins/PolygonMask.js
...
// CONCATENATED MODULE: ./dist/Enums/SizeMode.js
var SizeMode;
...
// CONCATENATED MODULE: ./dist/Options/Classes/Emitters/EmitterSize.js
...
// CONCATENATED MODULE: ./dist/Utils/Presets.js
class Presets {
...
// CONCATENATED MODULE: ./dist/Plugins/Absorber.js


class Plugins_Absorber_Absorber {
  ...
  draw(context) {
    ...
    context.closePath();
    context.fillStyle = ColorUtils_ColorUtils.getStyleFromColor(this.color, this.opacity);
    context.fill();
  }
...
// CONCATENATED MODULE: ./dist/Plugins/Absorbers.js
...
class Absorbers_Absorbers {
  ...
  init() {
    ...
    if (options.absorbers instanceof Array) {
      for (const absorberOptions of options.absorbers) {
        const absorber = new Plugins_Absorber_Absorber(this, absorberOptions);
  ...
  handleClickMode(mode) {
    ...
    if (mode === ClickMode.absorber) {
      ...
      const absorber = new Plugins_Absorber_Absorber(this, absorbersOptions, bhPosition);
      this.array.push(absorber);
    }
  }

}
// CONCATENATED MODULE: ./dist/Plugins/Emitter.js




class Plugins_Emitter_Emitter {
...
// CONCATENATED MODULE: ./dist/Plugins/Emitters.js
...
class Emitters_Emitters {
  ...
  init() {
    ...
    if (options.emitters instanceof Array) {
      for (const emitterOptions of options.emitters) {
        const emitter = new Plugins_Emitter_Emitter(this, emitterOptions);
  ...
  handleClickMode(mode) {
    ...
    if (mode === ClickMode.emitter) {
      ...
      const emitter = new Plugins_Emitter_Emitter(this, Utils_Utils.deepExtend({}, emitterOptions), ePosition);
      this.array.push(emitter);
    }
  }
  ...
  start() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (this.options.polygon.enable) {
        this.plugins.push(new PolygonMask_PolygonMask(this));
      }
      ...
      if (absorbers instanceof Array) {
        ...
        loadAbsorbers = true;
      } else if (Utils_Utils.isInArray(ClickMode.absorber, this.options.interactivity.events.onClick.mode)) {
        loadAbsorbers = true;
      }

      if (loadAbsorbers) {
        this.plugins.push(new Absorbers_Absorbers(this));
      }
      ...
      if (loadEmitters) {
        this.plugins.push(new Emitters_Emitters(this));
      }
      ...
      if (this.options.particles.shape.type instanceof Array) {
        for (const type of this.options.particles.shape.type) {
          this.drawers[type] = CanvasUtils_CanvasUtils.getShapeDrawer(type);
        }
      } else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (Utils_Utils.isInArray(ShapeType.char, options.particles.shape.type) || Utils_Utils.isInArray(ShapeType.character, options.particles.shape.type)) {
        ...
        if (shapeOptions instanceof Array) {
          ...
          const character = (_b = options.particles.shape.options[ShapeType.character]) !== null && _b !== void 0 ? _b : options.particles.shape.options[ShapeType.char];
...
class ImageDrawer_ImageDrawer {
  ...
  init(container) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      const options = container.options;
      const imageOptions = (_a = options.particles.shape.options[ShapeType.images]) !== null && _a !== void 0 ? _a : options.particles.shape.options[ShapeType.image];
  ...
  loadImageShape(container, imageShape) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const image = yield Utils_Utils.loadImage(imageShape.src);
...
class dist_Main {
  constructor() {
    ...
    CanvasUtils_CanvasUtils.addShapeDrawer(ShapeType.image, imageDrawer);
    CanvasUtils_CanvasUtils.addShapeDrawer(ShapeType.images, imageDrawer);
  }
