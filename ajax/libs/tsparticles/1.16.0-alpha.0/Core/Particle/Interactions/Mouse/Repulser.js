...
var Repulser = (function () {
    ...
    Repulser.repulse = function (container, _delta) {
        ...
        if (mouseMoveStatus && hoverEnabled && Utils_1.Utils.isInArray(Enums_1.HoverMode.repulse, hoverMode)) {
            ...
            if (divs instanceof Array) {
                ...
                var divMode = divs.mode;
                var divEnabled = divs.enable;
                if (divEnabled && Utils_1.Utils.isInArray(Enums_1.DivMode.repulse, divMode)) {
    ...
    Repulser.divRepulse = function (container, div) {
        var ids = div.ids;
    ...
    Repulser.singleDivRepulse = function (container, id, div) {
        ...
        var area = div.type === Enums_1.DivType.circle
            ? new Utils_1.Circle(pos.x, pos.y, repulseRadius)
            : new Utils_1.Rectangle(elem.offsetLeft, elem.offsetTop, elem.offsetWidth, elem.offsetHeight);
    ...
    Repulser.processRepulse = function (container, position, repulseRadius, area) {
