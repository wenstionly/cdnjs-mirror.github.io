...
export declare class CanvasUtils {
    ...
    static drawParticle(container: Container, context: CanvasRenderingContext2D, particle: IParticle, delta: number, fillColorValue: string, strokeColorValue: string, backgroundMask: boolean, radius: number, opacity: number, shadow: IShadow): void;
