...
class Particle_Particle {
  constructor(container, position, emitter) {
    ...
    if (this.shape === ShapeType.image || this.shape === ShapeType.images) {
      ...
      this.fill = (_p = optionsImage.fill) !== null && _p !== void 0 ? _p : this.fill;
      this.close = (_q = optionsImage.close) !== null && _q !== void 0 ? _q : this.close;
    }
...
// CONCATENATED MODULE: ./dist/Core/Absorber.js
...
// CONCATENATED MODULE: ./dist/Core/PolygonMask.js
...
class Container_Container {
  ...
  loadImageShape(imageShape) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        this.images.push(yield Utils_Utils.loadImage(imageShape.src));
      } catch (_a) {}
    });
  }
