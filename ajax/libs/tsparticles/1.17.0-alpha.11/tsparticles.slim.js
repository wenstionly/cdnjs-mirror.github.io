...
class Canvas_Canvas {
  ...
  drawParticle(particle, delta) {
    ...
    const radius = (_b = particle.bubble.radius) !== null && _b !== void 0 ? _b : particle.size.value;
...
class Particle_Particle {
  constructor(container, position, overrideOptions) {
    ...
    if (typeof this.stroke.color !== "string") {
      const strokeColorAnimation = (_p = this.stroke.color) === null || _p === void 0 ? void 0 : _p.animation;
...
class InteractionManager_InteractionManager {
  constructor(container) {
    this.container = container;
    this.externalInteractors = [new Bubbler_Bubbler(container), new Connector_Connector(container), new Grabber_Grabber(container), new Repulser_Repulser(container), new TrailMaker_TrailMaker(container)];
