...
var Canvas = (function () {
    ...
    Canvas.prototype.drawLinkTriangle = function (p1, link1, link2) {
        ...
        if (!colorTriangle) {
            if (container.particles.linksColor === Utils_1.Constants.randomColorValue) {
    ...
    Canvas.prototype.drawParticle = function (particle, delta) {
        ...
        var color = twinkling && twinkleRgb !== undefined
            ? twinkleRgb
            : (_c = infectionRgb !== null && infectionRgb !== void 0 ? infectionRgb : particle.bubble.color) !== null && _c !== void 0 ? _c : Utils_1.ColorUtils.hslToRgb(particle.color);
