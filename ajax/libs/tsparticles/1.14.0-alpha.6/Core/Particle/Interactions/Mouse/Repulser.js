...
var Repulser = (function () {
    ...
    Repulser.processRepulse = function (container, position, repulseRadius) {
        var query = container.particles.quadTree.query(new QuadTree_1.Circle(position.x, position.y, repulseRadius));
    ...
    Repulser.clickRepulse = function (container) {
        ...
        if (container.repulse.clicking) {
            ...
            var query = container.particles.quadTree.query(new QuadTree_1.Circle(mouseClickPos.x, mouseClickPos.y, repulseRadius));
