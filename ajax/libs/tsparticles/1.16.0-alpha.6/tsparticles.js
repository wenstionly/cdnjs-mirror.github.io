...
class Repulser_Repulser {
  ...
  isEnabled() {
    ...
    const divBubble = divs instanceof Array ? divs.filter(t => t.enable && Utils_Utils.isInArray(DivMode.repulse, t.mode)).length > 0 : Utils_Utils.isInArray(DivMode.bubble, divs.mode);
  ...
  processRepulse(position, repulseRadius, area) {
    const container = this.container;
...
class Bubbler_Bubbler {
  ...
  isEnabled() {
    ...
    const events = options.interactivity.events;
    const divs = events.onDiv;
    const divBubble = divs instanceof Array ? divs.filter(t => t.enable && Utils_Utils.isInArray(DivMode.bubble, t.mode)).length > 0 : Utils_Utils.isInArray(DivMode.bubble, divs.mode);
  ...
  hoverBubbleSize(particle, ratio) {
    var _a;
  ...
  hoverBubbleOpacity(particle, ratio) {
    const options = this.container.options;
