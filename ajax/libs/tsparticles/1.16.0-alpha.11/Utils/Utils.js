    ...
    static get cancelAnimation() {
        const cancelAnimation = this.isSsr()
            ...
            : ((handle) => window.cancelAnimationFrame(handle)) ||
                ((handle) => window.webkitCancelRequestAnimationFrame(handle)) ||
                ((handle) => window.mozCancelRequestAnimationFrame(handle)) ||
                ((handle) => window.oCancelRequestAnimationFrame(handle)) ||
                ((handle) => window.msCancelRequestAnimationFrame(handle)) ||
