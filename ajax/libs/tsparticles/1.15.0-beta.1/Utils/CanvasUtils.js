...
var CanvasUtils = (function () {
    ...
    CanvasUtils.gradient = function (context, p1, p2, opacity) {
        ...
        var color1 = (_a = p1.bubble.color) !== null && _a !== void 0 ? _a : (p1.color ? ColorUtils_1.ColorUtils.hslToRgb(p1.color) : undefined);
        var color2 = (_b = p2.bubble.color) !== null && _b !== void 0 ? _b : (p2.color ? ColorUtils_1.ColorUtils.hslToRgb(p2.color) : undefined);
        if (!color1 || !color2) {
            return;
        }
        ...
        grad.addColorStop(0, ColorUtils_1.ColorUtils.getStyleFromRgb(color1, opacity));
        grad.addColorStop(gradStop > 1 ? 1 : gradStop, ColorUtils_1.ColorUtils.getStyleFromRgb(midRgb, opacity));
        grad.addColorStop(1, ColorUtils_1.ColorUtils.getStyleFromRgb(color2, opacity));
        return grad;
    };
