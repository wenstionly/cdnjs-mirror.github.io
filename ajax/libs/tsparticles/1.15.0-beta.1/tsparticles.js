...
class CanvasUtils_CanvasUtils {
  ...
  static gradient(context, p1, p2, opacity) {
    ...
    const color1 = (_a = p1.bubble.color) !== null && _a !== void 0 ? _a : p1.color ? ColorUtils_ColorUtils.hslToRgb(p1.color) : undefined;
    const color2 = (_b = p2.bubble.color) !== null && _b !== void 0 ? _b : p2.color ? ColorUtils_ColorUtils.hslToRgb(p2.color) : undefined;
    ...
    grad.addColorStop(0, ColorUtils_ColorUtils.getStyleFromRgb(color1, opacity));
    grad.addColorStop(gradStop > 1 ? 1 : gradStop, ColorUtils_ColorUtils.getStyleFromRgb(midRgb, opacity));
    grad.addColorStop(1, ColorUtils_ColorUtils.getStyleFromRgb(color2, opacity));
    return grad;
  }
...
class PolygonMaskInstance_PolygonMaskInstance {
  ...
  checkInsidePolygon(position) {
    ...
    if (!polygonMaskOptions.enable || polygonMaskOptions.type === Type.none || polygonMaskOptions.type === Type.inline) {
      return true;
    }
  ...
  particlesInitialization() {
    ...
    if (polygonMaskOptions.enable && polygonMaskOptions.type === Type.inline && (polygonMaskOptions.inline.arrangement === InlineArrangement.onePerPoint || polygonMaskOptions.inline.arrangement === InlineArrangement.perPoint)) {
