...
var PolygonMaskInstance = (function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(polygonMaskOptions.enable && polygonMaskOptions.url)) return [3, 2];
                        _a = this;
                        return [4, this.parseSvgPathToPolygon(polygonMaskOptions.url)];
                    case 1:
                        _a.raw = _b.sent();
                        this.createPath2D();
                        _b.label = 2;
    ...
    PolygonMaskInstance.prototype.checkInsidePolygon = function (position) {
        ...
        if (!polygonMaskOptions.enable ||
            polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.none ||
            polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.inline) {
            return true;
        }
        if (!this.raw) {
        ...
        if (polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.inside) {
            return inside;
        }
        else if (polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.outside) {
            return !inside;
        }
        return false;
    };
    PolygonMaskInstance.prototype.resize = function () {
        ...
        var container = this.container;
        var polygonMaskOptions = this.options;
        if (polygonMaskOptions.enable && polygonMaskOptions.type !== PolygonMaskType_1.PolygonMaskType.none) {
    ...
    PolygonMaskInstance.prototype.randomPointInPolygon = function () {
        ...
        var polygonMaskOptions = this.options;
        var position;
        if (polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.inline) {
    ...
    PolygonMaskInstance.prototype.particlesInitialization = function () {
        ...
        if (polygonMaskOptions.enable &&
            polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.inline &&
            (polygonMaskOptions.inline.arrangement === PolygonMaskInlineArrangement_1.PolygonMaskInlineArrangement.onePerPoint ||
                polygonMaskOptions.inline.arrangement === PolygonMaskInlineArrangement_1.PolygonMaskInlineArrangement.perPoint)) {
    ...
    PolygonMaskInstance.prototype.particlePosition = function (position, particle) {
        ...
        if (polygonMaskOptions.enable && ((_b = (_a = this.raw) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0) {
            ...
            if (polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.inline && particle) {
    ...
    PolygonMaskInstance.prototype.particleBounce = function (particle, _delta) {
        ...
        else if (polygonMaskOptions.enable && polygonMaskOptions.type === PolygonMaskType_1.PolygonMaskType.inline) {
    ...
    PolygonMaskInstance.prototype.parseSvgPathToPolygon = function (svgUrl) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var container, polygonMaskOptions, url, req, xml, parser, doc, svgPaths, i, path, pxRatio, scale, position, polygonRaw, _i, _b, path, len, p, i, segment, absSeg, relSeg;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        scale = polygonMaskOptions.scale / pxRatio;
                        ...
                        position = (_a = polygonMaskOptions.position) !== null && _a !== void 0 ? _a : {
                            x: 50,
                            y: 50,
                        };
                        this.offset = {
