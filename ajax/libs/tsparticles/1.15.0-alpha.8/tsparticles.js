...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "particlesJS", function() { return /* reexport */ particlesJS; });
__webpack_require__.d(__webpack_exports__, "pJSDom", function() { return /* reexport */ pJSDom; });
__webpack_require__.d(__webpack_exports__, "tsParticles", function() { return /* reexport */ tsParticles; });
...
class CanvasUtils_CanvasUtils {
  ...
  static gradient(context, p1, p2, opacity) {
    ...
    grad.addColorStop(0, ColorUtils_ColorUtils.getStyleFromHsl(p1.color, opacity));
    grad.addColorStop(gradStop > 1 ? 1 : gradStop, ColorUtils_ColorUtils.getStyleFromRgb(midRgb, opacity));
    grad.addColorStop(1, ColorUtils_ColorUtils.getStyleFromHsl(p2.color, opacity));
    return grad;
  }
...
// CONCATENATED MODULE: ./dist/Utils/index.js
...
class Absorbers_Absorbers {
  ...
  init(options) {
    ...
    if (this.absorbers instanceof Array) {
      for (const absorberOptions of this.absorbers) {
        const absorber = new AbsorberInstance_AbsorberInstance(this, absorberOptions);
  ...
  handleClickMode(mode) {
    ...
    if (mode === ClickMode.absorber) {
      ...
      const absorber = new AbsorberInstance_AbsorberInstance(this, absorbersOptions, aPosition);
      this.addAbsorber(absorber);
    }
  }
...
class AbsorbersPlugin_AbsorbersPlugin {
  ...
  needsPlugin(options) {
    ...
    if (absorbers instanceof Array) {
      ...
      loadAbsorbers = true;
    } else if (((_c = (_b = (_a = options.interactivity) === null || _a === void 0 ? void 0 : _a.events) === null || _b === void 0 ? void 0 : _b.onClick) === null || _c === void 0 ? void 0 : _c.mode) && Utils_Utils.isInArray(ClickMode.absorber, options.interactivity.events.onClick.mode)) {
      loadAbsorbers = true;
    }
...
class Emitters_Emitters {
  ...
  init(options) {
    ...
    if (this.emitters instanceof Array) {
      for (const emitterOptions of this.emitters) {
        const emitter = new EmitterInstance_EmitterInstance(this, emitterOptions);
  ...
  handleClickMode(mode) {
    ...
    if (mode === ClickMode.emitter) {
      ...
      const emitter = new EmitterInstance_EmitterInstance(this, Utils_Utils.deepExtend({}, emittersOptions), ePosition);
      this.addEmitter(emitter);
    }
  }
...
// CONCATENATED MODULE: ./dist/Plugins/PolygonMask/Options/Classes/PolygonMaskDrawStroke.js
...
// CONCATENATED MODULE: ./dist/Plugins/PolygonMask/Options/Classes/PolygonInline.js
...
class PolygonMaskInstance_PolygonMaskInstance {
  ...
  initAsync(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (polygonMaskOptions.enable && polygonMaskOptions.url) {
        this.raw = yield this.parseSvgPathToPolygon(polygonMaskOptions.url);
        this.createPath2D();
      }
    });
  }
  ...
  checkInsidePolygon(position) {
    ...
    if (!polygonMaskOptions.enable || polygonMaskOptions.type === PolygonMaskType.none || polygonMaskOptions.type === PolygonMaskType.inline) {
      return true;
    }
    ...
    if (polygonMaskOptions.type === PolygonMaskType.inside) {
      return inside;
    } else if (polygonMaskOptions.type === PolygonMaskType.outside) {
      return !inside;
    }
  ...
  resize() {
    ...
    if (polygonMaskOptions.enable && polygonMaskOptions.type !== PolygonMaskType.none) {
  ...
  randomPointInPolygon() {
    ...
    if (polygonMaskOptions.type === PolygonMaskType.inline) {
  ...
  particlesInitialization() {
    ...
    if (polygonMaskOptions.enable && polygonMaskOptions.type === PolygonMaskType.inline && (polygonMaskOptions.inline.arrangement === PolygonMaskInlineArrangement.onePerPoint || polygonMaskOptions.inline.arrangement === PolygonMaskInlineArrangement.perPoint)) {
  ...
  particlePosition(position, particle) {
    ...
    if (polygonMaskOptions.enable && ((_b = (_a = this.raw) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0) {
      ...
      if (polygonMaskOptions.type === PolygonMaskType.inline && particle) {
  ...
  particleBounce(particle, _delta) {
    ...
    } else if (polygonMaskOptions.enable && polygonMaskOptions.type === PolygonMaskType.inline) {
  ...
  getRandomPointOnPolygonPathByLength() {
    ...
    return {
      x: point.x * polygonMaskOptions.scale + (((_a = this.offset) === null || _a === void 0 ? void 0 : _a.x) || 0),
      y: point.y * polygonMaskOptions.scale + (((_b = this.offset) === null || _b === void 0 ? void 0 : _b.y) || 0)
    };
  }
  ...
  getEquidistantPointOnPolygonPathByIndex(index) {
    ...
    return {
      x: ((_a = point === null || point === void 0 ? void 0 : point.x) !== null && _a !== void 0 ? _a : 0) * polygonMaskOptions.scale + ((_c = (_b = this.offset) === null || _b === void 0 ? void 0 : _b.x) !== null && _c !== void 0 ? _c : 0),
      y: ((_d = point === null || point === void 0 ? void 0 : point.y) !== null && _d !== void 0 ? _d : 0) * polygonMaskOptions.scale + ((_f = (_e = this.offset) === null || _e === void 0 ? void 0 : _e.y) !== null && _f !== void 0 ? _f : 0)
    };
  }
...
class Canvas_Canvas {
  ...
  drawParticle(particle, delta) {
    ...
    const color = twinkling && twinkleRgb !== undefined ? twinkleRgb : (_c = infectionRgb !== null && infectionRgb !== void 0 ? infectionRgb : particle.bubble.color) !== null && _c !== void 0 ? _c : ColorUtils_ColorUtils.hslToRgb(particle.color);
...
class Particles_Particles {
  constructor() {
    ...
    this.move = new Particles_Move_Move();
  ...
  constructor(container, position, overrideOptions) {
    ...
    if (this.shape === ShapeType.image || this.shape === ShapeType.images) {
      ...
      if ((image === null || image === void 0 ? void 0 : image.svgData) !== undefined && optionsImage.replaceColor && this.color) {
        const svgColoredData = Utils_Utils.replaceColorSvg(image, this.color, this.opacity.value);
...
class Bubbler_Bubbler {
  ...
  static hoverBubbleColor(container, particle) {
    ...
    if (particle.bubble.color === undefined) {
      ...
      particle.bubble.color = ColorUtils_ColorUtils.colorToRgb(bubbleColor);
    }
  }
...
class Retina {
  ...
  init() {
    ...
    this.bubbleModeSize = (_a = modes.bubble.size) !== null && _a !== void 0 ? _a : this.sizeValue * ratio;
  }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (const id in this.plugins) {
        ...
        if (plugin.init !== undefined) {
          ...
          yield plugin.initAsync(this.sourceOptions);
        }
      }
...
class StarDrawer {
  draw(context, particle, radius, opacity, _delta) {
    var _a, _b, _c;
...
tsParticles.addPlugin(new AbsorbersPlugin_AbsorbersPlugin());
tsParticles.addPlugin(new EmittersPlugin_EmittersPlugin());
tsParticles.addPlugin(new PolygonMaskPlugin_PolygonMaskPlugin());
