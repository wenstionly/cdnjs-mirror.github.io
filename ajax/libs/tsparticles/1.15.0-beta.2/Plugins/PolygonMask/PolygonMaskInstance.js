...
var PolygonMaskInstance = (function () {
    ...
    PolygonMaskInstance.prototype.checkInsidePolygon = function (position) {
        ...
        if (!polygonMaskOptions.enable ||
            polygonMaskOptions.type === Type_1.Type.none ||
            polygonMaskOptions.type === Type_1.Type.inline) {
            return true;
        }
        if (!this.raw) {
        ...
        if (polygonMaskOptions.type === Type_1.Type.inside) {
            return inside;
        }
        else if (polygonMaskOptions.type === Type_1.Type.outside) {
            return !inside;
        }
        return false;
    };
    PolygonMaskInstance.prototype.resize = function () {
        ...
        var container = this.container;
        var polygonMaskOptions = this.options;
        if (polygonMaskOptions.enable && polygonMaskOptions.type !== Type_1.Type.none) {
    ...
    PolygonMaskInstance.prototype.randomPointInPolygon = function () {
        ...
        var polygonMaskOptions = this.options;
        var position;
        if (polygonMaskOptions.type === Type_1.Type.inline) {
            switch (polygonMaskOptions.inline.arrangement) {
                case InlineArrangement_1.InlineArrangement.randomPoint:
                    position = this.getRandomPointOnPolygonPath();
                    break;
                case InlineArrangement_1.InlineArrangement.randomLength:
                    position = this.getRandomPointOnPolygonPathByLength();
                    break;
                case InlineArrangement_1.InlineArrangement.equidistant:
                    position = this.getEquidistantPointOnPolygonPathByIndex(container.particles.count);
                    break;
                case InlineArrangement_1.InlineArrangement.onePerPoint:
                case InlineArrangement_1.InlineArrangement.perPoint:
                default:
    ...
    PolygonMaskInstance.prototype.particlesInitialization = function () {
        ...
        if (polygonMaskOptions.enable &&
            polygonMaskOptions.type === Type_1.Type.inline &&
            (polygonMaskOptions.inline.arrangement === InlineArrangement_1.InlineArrangement.onePerPoint ||
                polygonMaskOptions.inline.arrangement === InlineArrangement_1.InlineArrangement.perPoint)) {
    ...
    PolygonMaskInstance.prototype.particlePosition = function (position, particle) {
        ...
        if (polygonMaskOptions.enable && ((_b = (_a = this.raw) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0) {
            ...
            if (polygonMaskOptions.type === Type_1.Type.inline && particle) {
    ...
    PolygonMaskInstance.prototype.particleBounce = function (particle, _delta) {
        ...
        else if (polygonMaskOptions.enable && polygonMaskOptions.type === Type_1.Type.inline) {
