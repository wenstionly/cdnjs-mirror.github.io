...
// EXTERNAL MODULE: ./dist/Options/Classes/Particles/Particles.js + 27 modules
...
class CanvasUtils_CanvasUtils {
  ...
  static drawLinkedLine(context, width, begin, end, maxDistance, canvasSize, warp, backgroundMask, colorLine, opacity, shadow) {
    context.beginPath();
...
class Canvas_Canvas {
  ...
  drawLinkedLine(p1, link) {
    ...
    CanvasUtils_CanvasUtils.drawLinkedLine(ctx, width, pos1, pos2, p1.particlesOptions.lineLinked.distance, container.canvas.size, p1.particlesOptions.lineLinked.warp, options.backgroundMask.enable, colorLine, opacity, p1.particlesOptions.lineLinked.shadow);
  }
...
var OptionsColor = __webpack_require__(4);
