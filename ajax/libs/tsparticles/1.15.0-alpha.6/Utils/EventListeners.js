...
var EventListeners = (function () {
    ...
    EventListeners.prototype.manageListeners = function (add) {
        ...
        if (detectType === InteractivityDetect_1.InteractivityDetect.window) {
            container.interactivity.element = window;
        }
        else if (detectType === InteractivityDetect_1.InteractivityDetect.parent && container.canvas.element) {
    ...
    EventListeners.prototype.handleClickMode = function (mode) {
        ...
        switch (mode) {
            ...
            case ClickMode_1.ClickMode.repulse:
                ...
                break;
            case ClickMode_1.ClickMode.pause:
                if (container.getAnimationStatus()) {
                    container.pause();
                }
                else {
