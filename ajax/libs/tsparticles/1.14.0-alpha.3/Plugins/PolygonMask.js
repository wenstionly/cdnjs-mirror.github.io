...
var PolygonMask = (function () {
    ...
    PolygonMask.prototype.initAsync = function () {
    ...
    PolygonMask.prototype.particleBounce = function (particle) {
        var container = this.container;
        var options = container.options;
        if (options.polygon.enable && options.polygon.type !== PolygonMaskType_1.PolygonMaskType.none &&
            options.polygon.type !== PolygonMaskType_1.PolygonMaskType.inline) {
            ...
            for (var _i = 0, _a = this.paths; _i < _a.length; _i++) {
                ...
                if (context_1) {
                    if (path2dSupported && path2d && this.offset) {
                        PolygonMask.drawPolygonMaskPath(context_1, path2d, polygonDraw.stroke, this.offset);
                    }
                    else if (rawData) {
                        PolygonMask.drawPolygonMask(context_1, rawData, polygonDraw.stroke);
                    }
                }
            }
        }
