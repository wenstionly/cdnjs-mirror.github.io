...
// CONCATENATED MODULE: ./dist/Core/Particle/Interactions/Particles/Interactions.js




class Interactions_Interactions {
  ...
  particlesInteract(delta) {
    ...
    for (const particle of container.particles.array) {
      ...
      if (this.interactionsEnabled) {
        Interactions_Interactions.interact(particle, container, delta);
      }
    }
  }
