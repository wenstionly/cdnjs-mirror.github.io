...
var Container = (function () {
    ...
    Container.prototype.start = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _i, _a, plugin, _b, _c, character, character, _d, _e, optionsImage;
                ...
                switch (_f.label) {
                    ...
                    case 5:
                        if (!(Utils_1.Utils.isInArray(ShapeType_1.ShapeType.char, this.options.particles.shape.type) ||
                            Utils_1.Utils.isInArray(ShapeType_1.ShapeType.character, this.options.particles.shape.type))) return [3, 12];
                        if (!(this.options.particles.shape.character instanceof Array)) return [3, 10];
                        _b = 0, _c = this.options.particles.shape.character;
                        _f.label = 6;
                    case 6:
                    ...
                    case 10:
                        ...
                        if (!(character !== undefined)) return [3, 12];
                        return [4, Utils_1.Utils.loadFont(character)];
                    case 11:
                        _f.sent();
                        _f.label = 12;
                    case 12:
                        if (!(Utils_1.Utils.isInArray(ShapeType_1.ShapeType.image, this.options.particles.shape.type) ||
                            Utils_1.Utils.isInArray(ShapeType_1.ShapeType.images, this.options.particles.shape.type))) return [3, 19];
                        if (!(this.options.particles.shape.image instanceof Array)) return [3, 17];
                        _d = 0, _e = this.options.particles.shape.image;
                        _f.label = 13;
                    case 13:
                    ...
                    case 15:
                        ...
                        return [3, 13];
                    case 16: return [3, 19];
                    case 17: return [4, this.loadImageShape(this.options.particles.shape.image)];
                    case 18:
                        _f.sent();
                        _f.label = 19;
                    case 19:
