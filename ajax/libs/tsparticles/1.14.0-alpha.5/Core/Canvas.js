...
var Canvas = (function () {
    ...
    Canvas.prototype.drawParticle = function (particle) {
        ...
        CanvasUtils_1.CanvasUtils.drawParticle(this.container, this.context, particle, colorValue, options.backgroundMask.enable, radius, opacity, particle.particlesOptions.shadow);
    };
    Canvas.prototype.drawPlugin = function (plugin) {
        if (!this.context) {
            return;
        }
        CanvasUtils_1.CanvasUtils.drawPlugin(this.context, plugin);
    };
