...
var Collider = (function () {
    ...
    Collider.collide = function (p1, container) {
        ...
        var query = container.particles.quadTree.query(new QuadTree_1.Circle(pos1.x, pos1.y, p1.size.value * 2));
        for (var _i = 0, query_1 = query; _i < query_1.length; _i++) {
            ...
            var dist = Utils_1.Utils.getDistanceBetweenCoordinates(pos1_1, pos2);
