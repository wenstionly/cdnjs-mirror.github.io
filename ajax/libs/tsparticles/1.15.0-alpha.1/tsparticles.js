...
// EXTERNAL MODULE: ./dist/Options/Classes/Particles/Particles.js + 28 modules
...
class Particle_Particle {
  constructor(container, position, overrideOptions) {
    ...
    if (((_m = this.shapeData) === null || _m === void 0 ? void 0 : _m.particles) !== undefined) {
      particlesOptions.load((_o = this.shapeData) === null || _o === void 0 ? void 0 : _o.particles);
    }
    ...
    const sizeValue = (_p = this.sizeValue) !== null && _p !== void 0 ? _p : container.retina.sizeValue;
    ...
    if (this.particlesOptions.size.animation.enable) {
      ...
      this.size.velocity = ((_q = this.sizeAnimationSpeed) !== null && _q !== void 0 ? _q : container.retina.sizeAnimationSpeed) / 100;
    ...
    if (this.shape === ShapeType["a" /* ShapeType */].image || this.shape === ShapeType["a" /* ShapeType */].images) {
      ...
      this.image = {
        ...
        replaceColor: (_r = optionsImage.replaceColor) !== null && _r !== void 0 ? _r : optionsImage.replace_color,
      ...
      this.fill = (_s = optionsImage.fill) !== null && _s !== void 0 ? _s : this.fill;
      this.close = (_t = optionsImage.close) !== null && _t !== void 0 ? _t : this.close;
    }
...
class CanvasUtils_CanvasUtils {
  ...
  static drawLinkLine(context, width, begin, end, maxDistance, canvasSize, warp, backgroundMask, colorLine, opacity, shadow) {
    let distance = Utils["a" /* Utils */].getDistance(begin, end);
    ...
    if (distance <= maxDistance) {
      ...
      if (distance <= maxDistance) {
        ...
        distance = Utils["a" /* Utils */].getDistance(begin, endSW);
        ...
        if (distance <= maxDistance) {
          ...
          distance = Utils["a" /* Utils */].getDistance(begin, endSE);
    ...
    context.strokeStyle = ColorUtils["a" /* ColorUtils */].getStyleFromRgb(colorLine, opacity);
    ...
    if (shadow.enable) {
      ...
      if (shadowColor) {
        ...
        context.shadowColor = ColorUtils["a" /* ColorUtils */].getStyleFromRgb(shadowColor);
      }
    }
  ...
  static drawLinkTriangle(context, width, pos1, pos2, pos3, backgroundMask, colorTriangle, opacityTriangle) {
    ...
    context.fillStyle = ColorUtils["a" /* ColorUtils */].getStyleFromRgb(colorTriangle, opacityTriangle);
    context.fill();
  }
  ...
  static gradient(context, p1, p2, opacity) {
    ...
    grad.addColorStop(0, ColorUtils["a" /* ColorUtils */].getStyleFromHsl(p1.color, opacity));
    grad.addColorStop(gradStop > 1 ? 1 : gradStop, ColorUtils["a" /* ColorUtils */].getStyleFromRgb(midRgb, opacity));
    grad.addColorStop(1, ColorUtils["a" /* ColorUtils */].getStyleFromHsl(p2.color, opacity));
    return grad;
  }
  ...
  static drawParticle(container, context, particle, delta, colorValue, backgroundMask, radius, opacity, shadow) {
    ...
    if (stroke.width > 0 && particle.strokeColor) {
      context.strokeStyle = ColorUtils["a" /* ColorUtils */].getStyleFromRgb(particle.strokeColor, particle.stroke.opacity);
...
class Canvas_Canvas {
  ...
  paint() {
    ...
    if (this.context) {
      if (options.backgroundMask.enable && options.backgroundMask.cover && this.coverColor) {
        this.paintBase(ColorUtils["a" /* ColorUtils */].getStyleFromRgb(this.coverColor));
      } else {
        this.paintBase();
      }
    }
  ...
  drawLinkTriangle(p1, link1, link2) {
    ...
    let colorTriangle = color !== undefined ? ColorUtils["a" /* ColorUtils */].colorToRgb(color) : undefined;
    ...
    if (!colorTriangle) {
      if (container.particles.lineLinkedColor === Constants["a" /* Constants */].randomColorValue) {
        ...
        colorTriangle = container.particles.lineLinkedColor;
      }
    }

    const width = (_b = p1.lineLinkedWidth) !== null && _b !== void 0 ? _b : container.retina.lineLinkedWidth;
  ...
  drawLinkLine(p1, link) {
    ...
    CanvasUtils_CanvasUtils.drawLinkLine(ctx, width, pos1, pos2, p1.particlesOptions.lineLinked.distance, container.canvas.size, p1.particlesOptions.lineLinked.warp, options.backgroundMask.enable, colorLine, opacity, p1.particlesOptions.lineLinked.shadow);
  }
  ...
  drawGrabLine(particle, lineColor, opacity, mousePos) {
    ...
    CanvasUtils_CanvasUtils.drawGrabLine(ctx, (_a = particle.lineLinkedWidth) !== null && _a !== void 0 ? _a : container.retina.lineLinkedWidth, beginPos, mousePos, lineColor, opacity);
  }
  ...
  drawParticle(particle, delta) {
    ...
    const color = twinkling && twinkleRgb !== undefined ? twinkleRgb : (_c = infectionRgb !== null && infectionRgb !== void 0 ? infectionRgb : particle.bubble.color) !== null && _c !== void 0 ? _c : ColorUtils["a" /* ColorUtils */].hslToRgb(particle.color);
    const colorValue = color !== undefined ? ColorUtils["a" /* ColorUtils */].getStyleFromRgb(color, opacity) : undefined;
    ...
    if (interactivity.events.onHover.enable && container.interactivity.status === Constants["a" /* Constants */].mouseMoveEvent) {
      ...
      for (const particle of query) {
        ...
        if (distance <= container.retina.grabModeDistance) {
          ...
          if (opacityLine > 0) {
            const optColor = (_a = grabLineOptions.color) !== null && _a !== void 0 ? _a : particle.particlesOptions.lineLinked.color;

            if (!container.particles.grabLineColor) {
              container.particles.grabLineColor = typeof optColor === "string" && optColor === Constants["a" /* Constants */].randomColorValue || ((_b = optColor) === null || _b === void 0 ? void 0 : _b.value) === Constants["a" /* Constants */].randomColorValue ? Constants["a" /* Constants */].randomColorValue : typeof optColor === "string" ? ColorUtils["a" /* ColorUtils */].stringToRgb(optColor) : ColorUtils["a" /* ColorUtils */].colorToRgb(optColor);
            }
...
// EXTERNAL MODULE: ./dist/Options/Classes/OptionsColor.js
...
class GrabLineLinked_GrabLineLinked {
  constructor() {
    this.opacity = 1;
  }
...
class Grab_Grab {
  constructor() {
    this.distance = 100;
    this.lineLinked = new GrabLineLinked_GrabLineLinked();
  }
...
class AnimatableColor_AnimatableColor extends OptionsColor["a" /* OptionsColor */] {
  constructor() {
    super();
...
// CONCATENATED MODULE: ./dist/Options/Classes/Particles/LineLinked/LineLinkedTriangle.js

class LineLinkedTriangle_LineLinkedTriangle {
  constructor() {
    this.enable = false;
  }
...
class LineLinked_LineLinked {
  constructor() {
    ...
    this.triangles = new LineLinkedTriangle_LineLinkedTriangle();
    this.width = 1;
    this.warp = false;
  }
...
// EXTERNAL MODULE: ./dist/index.slim.js + 70 modules
