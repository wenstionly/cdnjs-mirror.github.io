...
var Canvas = (function () {
    ...
    Canvas.prototype.paint = function () {
        ...
        if (this.context) {
            if (options.backgroundMask.enable && options.backgroundMask.cover && this.coverColor) {
                this.paintBase(ColorUtils_1.ColorUtils.getStyleFromRgb(this.coverColor));
            }
            else {
                this.paintBase();
            }
    ...
    Canvas.prototype.clear = function () {
        ...
        if (options.backgroundMask.enable) {
            ...
            this.paintBase(ColorUtils_1.ColorUtils.getStyleFromRgb(this.trailFillColor, 1 / trail.length));
        }
    ...
    Canvas.prototype.drawLinkTriangle = function (p1, link1, link2) {
        ...
        var triangleOptions = p1.particlesOptions.lineLinked.triangles;
        ...
        var color = typeof triangleOptions.color === "string" ?
            { value: triangleOptions.color } :
            triangleOptions.color;
        var colorTriangle = color !== undefined ? ColorUtils_1.ColorUtils.colorToRgb(color) : undefined;
        if (!colorTriangle) {
            if (container.particles.lineLinkedColor === Constants_1.Constants.randomColorValue) {
                colorTriangle = ColorUtils_1.ColorUtils.getRandomRgbColor();
            }
            else if (container.particles.lineLinkedColor == "mid" && p1.color && p2.color) {
                var sourceColor = p1.color;
                var destColor = p2.color;
                colorTriangle = ColorUtils_1.ColorUtils.mix(sourceColor, destColor, p1.size.value, p2.size.value);
            }
            else {
                colorTriangle = container.particles.lineLinkedColor;
            }
        }
        var width = (_b = p1.lineLinkedWidth) !== null && _b !== void 0 ? _b : container.retina.lineLinkedWidth;
        CanvasUtils_1.CanvasUtils.drawLinkTriangle(ctx, width, pos1, pos2, pos3, options.backgroundMask.enable, colorTriangle, opacityTriangle);
    };
    Canvas.prototype.drawLinkLine = function (p1, link) {
        ...
        CanvasUtils_1.CanvasUtils.drawLinkLine(ctx, width, pos1, pos2, p1.particlesOptions.lineLinked.distance, container.canvas.size, p1.particlesOptions.lineLinked.warp, options.backgroundMask.enable, colorLine, opacity, p1.particlesOptions.lineLinked.shadow);
    };
    ...
    Canvas.prototype.drawGrabLine = function (particle, lineColor, opacity, mousePos) {
        ...
        CanvasUtils_1.CanvasUtils.drawGrabLine(ctx, (_a = particle.lineLinkedWidth) !== null && _a !== void 0 ? _a : container.retina.lineLinkedWidth, beginPos, mousePos, lineColor, opacity);
    };
    Canvas.prototype.drawParticle = function (particle, delta) {
        ...
        var color = twinkling && twinkleRgb !== undefined ?
            twinkleRgb : (_c = infectionRgb !== null && infectionRgb !== void 0 ? infectionRgb : particle.bubble.color) !== null && _c !== void 0 ? _c : ColorUtils_1.ColorUtils.hslToRgb(particle.color);
        var colorValue = color !== undefined ? ColorUtils_1.ColorUtils.getStyleFromRgb(color, opacity) : undefined;
    ...
    Canvas.prototype.initBackground = function () {
        ...
        if (background.color) {
            ...
            if (color) {
                elementStyle.backgroundColor = ColorUtils_1.ColorUtils.getStyleFromRgb(color, background.opacity);
            }
        }
        if (background.image) {
