...
const Badge = /*#__PURE__*/React.forwardRef(function Badge(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(ComponentProp, _extends({
    ...
    className: clsx(classes.badge, classes[`anchorOrigin${capitalize(anchorOrigin.vertical)}${capitalize(anchorOrigin.horizontal)}${capitalize(overlap)}`], color !== 'default' && classes[`color${capitalize(color)}`], invisible && classes.invisible, variant === 'dot' && classes.dot)
  }, displayValue));
});
