 ...
 */
export declare const CreateGame: (db: StorageAPI.Sync | StorageAPI.Async, game: Game<any, import("../types").Ctx>, numPlayers: number, setupData: object, lobbyConfig: Server.LobbyConfig) => Promise<string>;
