...
function () {
  function Bot(_ref) {
    ...
    turnOrder._classCallCheck(this, Bot);

    turnOrder._defineProperty(this, "enumerate", function (G, ctx, playerID) {
  ...
  turnOrder._createClass(Bot, [{
    ...
    value: function random(arg) {
      ...
      if (this.seed !== undefined) {
        ...
        if (this.prngstate) {
          r = new turnOrder.alea('', {
            state: this.prngstate
          });
        } else {
          r = new turnOrder.alea(this.seed, {
            state: true
          });
        }
...
/*#__PURE__*/
function (_Bot) {
  turnOrder._inherits(MCTSBot, _Bot);
  ...
  function MCTSBot(_ref) {
    ...
    turnOrder._classCallCheck(this, MCTSBot);

    _this = turnOrder._possibleConstructorReturn(this, turnOrder._getPrototypeOf(MCTSBot).call(this, {
      enumerate: enumerate,
      seed: seed
    }));
  ...
  turnOrder._createClass(MCTSBot, [{
    key: "createNode",
    ...
    value: function playout(node) {
      ...
      for (var i = 0; i < playoutDepth && state.ctx.gameover === undefined; i++) {
        ...
        if (turnOrder._typeof(_ret) === "object") return _ret.v;
      }
...
/*#__PURE__*/
function (_Bot) {
  turnOrder._inherits(RandomBot, _Bot);

  function RandomBot() {
    turnOrder._classCallCheck(this, RandomBot);

    return turnOrder._possibleConstructorReturn(this, turnOrder._getPrototypeOf(RandomBot).apply(this, arguments));
  }

  turnOrder._createClass(RandomBot, [{
    key: "play",
