import { e as error, l as UNDO, m as REDO, M as MAKE_MOVE } from './turn-order-b89c94e7.js';
 ...
 */
const getPlayerMetadata = (matchMetadata, playerID) => {
 ...
 */
const doesMatchRequireAuthentication = (matchMetadata) => {
    if (!matchMetadata)
        return false;
    const { players } = matchMetadata;
