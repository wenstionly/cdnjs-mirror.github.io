...
require('./Debug-ce71f7ad.js');
require('flatted');
var ai = require('./ai-c0ae2d45.js');
require('./initialize-25cb4fc8.js');
var client = require('./client-c9eb982f.js');
...
function (_React$Component) {
  ...
  function LobbyMatchInstance() {
    ...
    _this = turnOrder._possibleConstructorReturn(this, (_getPrototypeOf2 = turnOrder._getPrototypeOf(LobbyMatchInstance)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function LobbyCreateMatchForm(props) {
    ...
    _this = turnOrder._possibleConstructorReturn(this, turnOrder._getPrototypeOf(LobbyCreateMatchForm).call(this, props));
