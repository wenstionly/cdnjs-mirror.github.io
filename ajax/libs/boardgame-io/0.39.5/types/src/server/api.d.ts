 ...
 */
export declare const CreateGame: (db: StorageAPI.Sync | StorageAPI.Async, game: GameConfig, numPlayers: number, setupData: object, lobbyConfig: Server.LobbyConfig) => Promise<string>;
