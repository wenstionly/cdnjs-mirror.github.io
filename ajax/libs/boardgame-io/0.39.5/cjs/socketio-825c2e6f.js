...
var master = require('./master-02f7a99e.js');
...
function (_Transport) {
  ...
  function LocalTransport(_ref4) {
    ...
    _this = reducer._possibleConstructorReturn(this, reducer._getPrototypeOf(LocalTransport).call(this, {
      store: store,
      gameName: gameName,
      playerID: playerID,
      gameID: gameID,
...
function (_Transport) {
  ...
  function SocketIOTransport() {
    ...
    _this = reducer._possibleConstructorReturn(this, reducer._getPrototypeOf(SocketIOTransport).call(this, {
      store: store,
      gameName: gameName,
      playerID: playerID,
      gameID: gameID,
