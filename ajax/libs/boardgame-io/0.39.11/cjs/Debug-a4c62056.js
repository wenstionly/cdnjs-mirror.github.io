...
function instance$4($$self, $$props, $$invalidate) {
  ...
  function Restore() {
    ...
    if (gamestateJSON !== null) {
      ...
      client.store.dispatch(game.sync(gamestate));
    }
  }
...
function instance$i($$self, $$props, $$invalidate) {
  ...
  function OnLogClick(e) {
    ...
    const renderedLogEntries = log.filter(e => e.action.type == game.MAKE_MOVE);
  ...
  let phaseBoundaries = {};
	...
	$$self.$$.update = ($$dirty = { $client: 1, log: 1, renderedLogEntries: 1 }) => {
        ...
        $$invalidate('renderedLogEntries', renderedLogEntries = log.filter(e => e.action.type == game.MAKE_MOVE));
