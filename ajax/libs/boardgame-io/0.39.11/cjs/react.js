...
require('redux');
require('immer');
require('./Debug-a4c62056.js');
require('flatted');
var ai = require('./ai-8490fdc5.js');
require('./initialize-58dc4481.js');
var client = require('./client-26a1b94a.js');
var React = _interopDefault(require('react'));
var PropTypes = _interopDefault(require('prop-types'));
var Cookies = _interopDefault(require('react-cookies'));
require('./base-bdd9c13b.js');
var socketio = require('./socketio-75490257.js');
require('./master-1f9698a1.js');
...
function Client(opts) {
  ...
  function (_React$Component) {
    game._inherits(WrappedBoard, _React$Component);

    function WrappedBoard(props) {
      var _this;

      game._classCallCheck(this, WrappedBoard);

      _this = game._possibleConstructorReturn(this, game._getPrototypeOf(WrappedBoard).call(this, props));
    ...
    game._createClass(WrappedBoard, [{
      ...
      value: function render() {
        ...
        if (board) {
          _board = React.createElement(board, game._objectSpread2({}, state, {}, this.props, {
    ...
    return WrappedBoard;
  }(React.Component), game._defineProperty(_class, "propTypes", {
    ...
    debug: PropTypes.any
  }), game._defineProperty(_class, "defaultProps", {
    gameID: 'default',
    playerID: null,
    credentials: null,
    debug: true
...
function () {
  function _LobbyConnectionImpl(_ref) {
    ...
    game._classCallCheck(this, _LobbyConnectionImpl);
  ...
  game._createClass(_LobbyConnectionImpl, [{
    key: "_baseUrl",
...
/*#__PURE__*/
function (_React$Component) {
  game._inherits(LobbyLoginForm, _React$Component);
  ...
  function LobbyLoginForm() {
    ...
    game._classCallCheck(this, LobbyLoginForm);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = game._possibleConstructorReturn(this, (_getPrototypeOf2 = game._getPrototypeOf(LobbyLoginForm)).call.apply(_getPrototypeOf2, [this].concat(args)));

    game._defineProperty(game._assertThisInitialized(_this), "state", {
      playerName: _this.props.playerName,
      nameErrorMsg: ''
    });

    game._defineProperty(game._assertThisInitialized(_this), "onClickEnter", function () {
      if (_this.state.playerName === '') return;

      _this.props.onEnter(_this.state.playerName);
    });

    game._defineProperty(game._assertThisInitialized(_this), "onKeyPress", function (event) {
      if (event.key === 'Enter') {
        _this.onClickEnter();
      }
    });

    game._defineProperty(game._assertThisInitialized(_this), "onChangePlayerName", function (event) {
  ...
  game._createClass(LobbyLoginForm, [{
    key: "render",
    value: function render() {
...
game._defineProperty(LobbyLoginForm, "propTypes", {
  playerName: PropTypes.string,
  onEnter: PropTypes.func.isRequired
});

game._defineProperty(LobbyLoginForm, "defaultProps", {
  playerName: ''
});
...
/*#__PURE__*/
function (_React$Component) {
  game._inherits(LobbyRoomInstance, _React$Component);
  ...
  function LobbyRoomInstance() {
    ...
    game._classCallCheck(this, LobbyRoomInstance);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = game._possibleConstructorReturn(this, (_getPrototypeOf2 = game._getPrototypeOf(LobbyRoomInstance)).call.apply(_getPrototypeOf2, [this].concat(args)));

    game._defineProperty(game._assertThisInitialized(_this), "_createSeat", function (player) {
      return player.name || '[free]';
    });

    game._defineProperty(game._assertThisInitialized(_this), "_createButtonJoin", function (inst, seatId) {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createButtonLeave", function (inst) {
      return React.createElement("button", {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createButtonPlay", function (inst, seatId) {
      return React.createElement("button", {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createButtonSpectate", function (inst) {
      return React.createElement("button", {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createInstanceButtons", function (inst) {
  ...
  game._createClass(LobbyRoomInstance, [{
    key: "render",
    value: function render() {
...
game._defineProperty(LobbyRoomInstance, "propTypes", {
...
/*#__PURE__*/
function (_React$Component) {
  game._inherits(LobbyCreateRoomForm, _React$Component);

  function LobbyCreateRoomForm(props) {
    var _this;

    game._classCallCheck(this, LobbyCreateRoomForm);

    _this = game._possibleConstructorReturn(this, game._getPrototypeOf(LobbyCreateRoomForm).call(this, props));
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createGameNameOption", function (game, idx) {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createNumPlayersOption", function (idx) {
      return React.createElement("option", {
        key: 'num-option-' + idx,
        value: idx
      }, idx);
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createNumPlayersRange", function (game$1) {
      return game._toConsumableArray(new Array(game$1.maxPlayers + 1).keys()).slice(game$1.minPlayers);
    });

    game._defineProperty(game._assertThisInitialized(_this), "onChangeNumPlayers", function (event) {
      _this.setState({
        numPlayers: Number.parseInt(event.target.value)
      });
    });

    game._defineProperty(game._assertThisInitialized(_this), "onChangeSelectedGame", function (event) {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "onClickCreate", function () {
    ...
    try {
      for (var _iterator = props.games[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var game$1 = _step.value;
        var game_details = game$1.game;
  ...
  game._createClass(LobbyCreateRoomForm, [{
    key: "render",
    value: function render() {
      var _this2 = this;
...
game._defineProperty(LobbyCreateRoomForm, "propTypes", {
...
/*#__PURE__*/
function (_React$Component) {
  game._inherits(Lobby, _React$Component);

  function Lobby(_props) {
    var _this;

    game._classCallCheck(this, Lobby);

    _this = game._possibleConstructorReturn(this, game._getPrototypeOf(Lobby).call(this, _props));
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createConnection", function (props) {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_updateCredentials", function (playerName, credentials) {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_updateConnection", async function () {
      await _this.connection.refresh();

      _this.forceUpdate();
    });

    game._defineProperty(game._assertThisInitialized(_this), "_enterLobby", function (playerName) {
      _this.setState({
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_exitLobby", async function () {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_createRoom", async function (gameName, numPlayers) {
      try {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_joinRoom", async function (gameName, gameID, playerID) {
      try {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_leaveRoom", async function (gameName, gameID) {
      try {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_startGame", function (gameName, gameOpts) {
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_exitRoom", function () {
      _this.setState({
        phase: LobbyPhases.LIST,
        runningGame: null
      });
    ...
    game._defineProperty(game._assertThisInitialized(_this), "_getPhaseVisibility", function (phase) {
      return _this.state.phase !== phase ? 'hidden' : 'phase';
    });

    game._defineProperty(game._assertThisInitialized(_this), "renderRooms", function (rooms, playerName) {
...
game._defineProperty(Lobby, "propTypes", {
...
game._defineProperty(Lobby, "defaultProps", {
  debug: false,
