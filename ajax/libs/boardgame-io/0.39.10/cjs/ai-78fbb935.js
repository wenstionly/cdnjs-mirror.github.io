...
function (_Bot) {
  ...
  function MCTSBot(_ref) {
    ...
    _this = reducer._possibleConstructorReturn(this, reducer._getPrototypeOf(MCTSBot).call(this, {
      enumerate: enumerate,
      seed: seed
    }));
...
function (_Bot) {
  ...
  function RandomBot() {
    ...
    return reducer._possibleConstructorReturn(this, reducer._getPrototypeOf(RandomBot).apply(this, arguments));
  }
