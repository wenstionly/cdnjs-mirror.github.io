(function (global, factory) {
  ...
  function (_BaseComponent) {
    ...
    _proto.__mountChildrenImpl = function __mountChildrenImpl(parent, children, context, nativeNodeMounter, didMountWorks) {
      ...
      for (var i = 0, l = children.length; i < l; i++) {
        ...
        var mountImage = renderedChild.__mountComponent(parent, this[INSTANCE], context, nativeNodeMounter, didMountWorks);
  ...
  function (_BaseComponent) {
    ...
    _proto.__mountComponent = function __mountComponent(parent, parentInstance, context, nativeNodeMounter, didMountWorks) {
      ...
      this[RENDERED_COMPONENT].__mountComponent(this._parent, instance, this.__processChildContext(context), nativeNodeMounter, didMountWorks);
