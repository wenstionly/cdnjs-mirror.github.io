    ...
    if ( (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if ( !styles.has(scopeId) && Cstr.style) {
            ...
            if ( cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await import('./shadow-css-39380d72.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-7354a97e.js').then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "polyfills-dom" */ './dom-f4fc1280.js').then(() => opts);
        }
    }
