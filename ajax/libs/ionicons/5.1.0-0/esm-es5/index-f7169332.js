    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, import('./shadow-css-39380d72.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 3:
                style_1 = _a.sent();
                _a.label = 4;
            case 4:
...
var patchEsm = function () {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-7354a97e.js').then(function () {
...
var patchBrowser = function () {
    ...
    }
    {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "polyfills-dom" */ './dom-f4fc1280.js').then(function () { return opts; });
        }
    }
