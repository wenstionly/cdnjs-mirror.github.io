...
var dark = ".btn{color:#fafbfc;background-color:#202428;background-image:-webkit-linear-gradient(top, #2f363d, #202428 90%);background-image:-moz-linear-gradient(top, #2f363d, #202428 90%);background-image:linear-gradient(180deg, #2f363d, #202428 90%);border-color:#2b3138;border-color:rgba(27,31,35,.2);-ms-filter:\"progid:DXImageTransform.Microsoft.Gradient(startColorstr='#FF2F363D', endColorstr='#FF1E2226')\";*filter:progid:DXImageTransform.Microsoft.Gradient(startColorstr=\"#FF2F363D\", endColorstr=\"#FF1E2226\")}.btn:focus,.btn:hover{background-color:#1b1f23;background-image:-webkit-linear-gradient(top, #2b3137, #1b1f23 90%);background-image:-moz-linear-gradient(top, #2b3137, #1b1f23 90%);background-image:linear-gradient(180deg, #2b3137, #1b1f23 90%);background-position:-0.5em;border-color:#252b30;border-color:rgba(27,31,35,.5);-ms-filter:\"progid:DXImageTransform.Microsoft.Gradient(startColorstr='#FF2B3137', endColorstr='#FF191D21')\";*filter:progid:DXImageTransform.Microsoft.Gradient(startColorstr=\"#FF2B3137\", endColorstr=\"#FF191D21\")}.btn:active{background-color:#181b1f;background-image:none;border-color:#252b30;border-color:rgba(27,31,35,.5);box-shadow:inset 0 .15em .3em rgba(27,31,35,.15);-ms-filter:\"\";*filter:none}.social-count{color:#fafbfc;background-color:#1b1f23;border-color:#1b1f23}.social-count b{border-right-color:#1b1f23}.social-count i{border-right-color:#1b1f23}.social-count:focus,.social-count:hover{color:#2188ff}.octicon-heart{color:#ec6cb9}";
