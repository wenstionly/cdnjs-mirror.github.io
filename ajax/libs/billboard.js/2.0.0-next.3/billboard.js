...
/* harmony default export */ var shape_arc = ({
  ...
  updateTargetsForArc: function updateTargetsForArc(targets) {
    var $$ = this,
        ...
        classFocus = $$.classFocus.bind($$),
        chartArcs = main.select("." + config_classes.chartArcs),
