(function (global, factory) {
  ...
  (global = global || self, factory(global.Dropbox = {}, global.crypto));
  ...
  var base64Js$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': base64Js,
    __moduleExports: base64Js,
    byteLength: byteLength_1,
    toByteArray: toByteArray_1,
    fromByteArray: fromByteArray_1
  });
  ...
  var base64 = ( base64Js$1 && base64Js ) || base64Js$1;
  ...
  Buffer.prototype.readFloatLE = function readFloatLE (offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 4, this.length);
    return ieee754$2.read(this, offset, true, 23, 4)
  };

  Buffer.prototype.readFloatBE = function readFloatBE (offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 4, this.length);
    return ieee754$2.read(this, offset, false, 23, 4)
  };

  Buffer.prototype.readDoubleLE = function readDoubleLE (offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 8, this.length);
    return ieee754$2.read(this, offset, true, 52, 8)
  };

  Buffer.prototype.readDoubleBE = function readDoubleBE (offset, noAssert) {
    offset = offset >>> 0;
    if (!noAssert) checkOffset(offset, 8, this.length);
    return ieee754$2.read(this, offset, false, 52, 8)
  };
  ...
  function writeFloat (buf, value, offset, littleEndian, noAssert) {
    ...
    ieee754$2.write(buf, value, offset, littleEndian, 23, 4);
    return offset + 4
  }
  ...
  function writeDouble (buf, value, offset, littleEndian, noAssert) {
    ...
    ieee754$2.write(buf, value, offset, littleEndian, 52, 8);
    return offset + 8
  }
  ...
  var dropbox$1 = ( dropbox && Dropbox ) || dropbox;

  var dropboxTeam$1 = ( dropboxTeam && DropboxTeam ) || dropboxTeam;
