...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3plus-axis'), require('d3plus-color'), require('d3plus-common'), require('d3plus-geomap'), require('d3plus-format'), require('d3plus-hierarchy'), require('d3plus-legend'), require('d3plus-network'), require('d3plus-plot'), require('d3plus-priestley'), require('d3plus-shape'), require('d3plus-text'), require('d3plus-timeline'), require('d3plus-tooltip'), require('d3plus-viz')) :
  typeof define === 'function' && define.amd ? define('d3plus', ['exports', 'd3plus-axis', 'd3plus-color', 'd3plus-common', 'd3plus-geomap', 'd3plus-format', 'd3plus-hierarchy', 'd3plus-legend', 'd3plus-network', 'd3plus-plot', 'd3plus-priestley', 'd3plus-shape', 'd3plus-text', 'd3plus-timeline', 'd3plus-tooltip', 'd3plus-viz'], factory) :
  (global = global || self, factory(global.d3plus = {}, global.d3plusAxis, global.d3plusColor, global.d3plusCommon, global.d3plusGeomap, global.d3plusFormat, global.d3plusHierarchy, global.d3plusLegend, global.d3plusNetwork, global.d3plusPlot, global.d3plusPriestley, global.d3plusShape, global.d3plusText, global.d3plusTimeline, global.d3plusTooltip, global.d3plusViz));
}(this, (function (exports, d3plusAxis, d3plusColor, d3plusCommon, d3plusGeomap, d3plusFormat, d3plusHierarchy, d3plusLegend, d3plusNetwork, d3plusPlot, d3plusPriestley, d3plusShape, d3plusText, d3plusTimeline, d3plusTooltip, d3plusViz) { 'use strict';
