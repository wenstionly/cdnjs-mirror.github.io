/* muse-ui myron.liu version 3.0.0-rc.3 */
import Vue from 'vue';
  ...
  methods: {
    validate: function validate() {
      ...
      for (var i = 0; i < this.rules.length; i++) {
        ...
        var result = rule.validate(this.muForm.model[this.prop], this.muForm.model);
        if (isPromise(result)) {
          promises.push(result);
...
var Menu = {
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      on: {
        click: function click() {
          return _this4.openOnHover ? null : _this4.active ? _this4.hide() : _this4.show();
        },
        mouseenter: function mouseenter() {
          return _this4.openOnHover && _this4.show();
        },
        mouseleave: function mouseleave() {
          return _this4.openOnHover && _this4.hide();
        }
      }
...
function MuseUI(Vue$$1) {
  [Alert, AppBar, AutoComplete, Avatar, Badge, BottomNav, BottomSheet, Breadcrumbs, Button, Card, Carousel, Checkbox, Chip, DataTable, DateInput, Dialog, Divider, Drawer, ExpansionPanel, Form, Grid, GridList, Helpers, Icon, LoadMore, List, Menu, Pagination, Paper, Picker, Popover, Progress, Radio, Select, Picker$1, Slider, Snackbar, Stepper, SubHeader, Switch, Tabs, TextField, Tooltip].forEach(function (component) {
    Vue$$1.use(component);
  });
}

MuseUI.theme = theme;
MuseUI.Colors = colorsObj;
MuseUI.version = '3.0.0-rc.3';
