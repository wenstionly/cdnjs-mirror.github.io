/* muse-ui myron.liu version 3.0.0-rc.2 */
import Vue from 'vue';
...
var AutoComplete = {
  ...
  methods: {
    ...
    setScollPosition: function setScollPosition(index) {
      ...
      if (!this.open) return;
      this.$nextTick(function () {
        var popoverEl = _this.$refs.list.$el;
...
var DateInput = {
  ...
  data: function data() {
    return {
      open: false,
      date: this.value ? dayjs_min(this.value).toDate() : undefined
    };
  },
...
var FormItem = {
  ...
  methods: {
    ...
    createLabel: function createLabel(h) {
      ...
      var value = this.muForm.model[this.prop];
      return h('div', {
