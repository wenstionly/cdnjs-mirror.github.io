...
function defineMixin(legacyGlobal, composer) {
    return {
        beforeCreate() {
            ...
            console.log('mixin options', this, options, getCurrentInstance());
            if (options.i18n) {
...
const VERSION = "9.0.0-alpha.3";

export { Availabilities, GlobalI18nSymbol, VERSION, createI18n, useI18n };
