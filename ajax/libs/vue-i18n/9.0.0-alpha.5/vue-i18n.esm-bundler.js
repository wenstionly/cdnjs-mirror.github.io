/*!
  ...
  */
import { defineComponent, getCurrentInstance, h, Fragment, ref, computed, createTextVNode, inject, provide, onMounted, onUnmounted } from 'vue';
...
function translate(context, ...args) {
    ...
    const msg = isMessageFunction(format)
        ? format
        : compile(format, getCompileOptions(targetLocale, cacheBaseKey, format, warnHtmlMessage, errorDetector));
...
function getCompileOptions(locale, key, source, warnHtmlMessage, errorDetector) {
    return {
        ...
        onCacheKey: (source) => `{${locale}}{${key}}{${source}}`
    };
}
...
function setupLifeCycle(instance, composer) {
    onMounted(() => {
...
const VERSION = "9.0.0-alpha.5";

export { Availabilities, VERSION, createI18n, createParser, useI18n };
