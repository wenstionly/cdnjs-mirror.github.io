 ...
 */
import { ref, getCurrentInstance, computed, inject, provide } from 'vue';
 ...
 */
function createI18nComposer(options = {}, _root // for internal
) {
    // reactivity states
    const _locale = ref(
    // prettier-ignore
 ...
 */
function createI18n(options = {}, _root // for internal option
) {
    const composer = createI18nComposer(convertI18nComposerOptions(options), _root);
    // defines VueI18n
    const i18n = {
        /**
         * properties
...
export { GlobalI18nSymbol, MISSING_RESOLVE_VALUE, NOT_REOSLVED, VERSION, clearDateTimeFormat, clearNumberFormat, compile, createCompiler, createI18n, createI18nComposer, createParser, createRuntimeContext, createTokenizer, datetime, fallback, isArray, isBoolean, isDate, isEmptyObject, isFunction, isNumber, isObject, isPlainObject, isPromise, isRegExp, isString, isSymbol, isTrarnslateFallbackWarn, number, objectToString, parse, parseDateTimeArgs, parseNumberArgs, parseTranslateArgs, toDisplayString, toTypeString, translate, useI18n, warn };
