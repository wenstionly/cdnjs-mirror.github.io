...
var VueI18n = (function (exports, vue) {
  ...
  function fallback(context, key, fallbackWarn, type, fn, fallbackFormat, defaultReturn) {
      ...
      if ( isTrarnslateFallbackWarn(fallbackWarn, key)) {
  ...
  function defineRuntimeMissingHandler(missing) {
      return (ctx, locale, key) => {
          return missing(locale, key, vue.getCurrentInstance() || undefined);
      };
  }
  ...
  function createI18nComposer(options = {}, _root // for internal
      ...
      _root
          ...
          : isString(options.locale)
              ? options.locale
              : 'en-US');
      const _fallbackLocales = vue.ref(
      // prettier-ignore
      _root
      ...
      // fallbackLocales
      const fallbackLocales = vue.computed({
