/*!
  ...
  */
import { defineComponent, h, Fragment, ref, getCurrentInstance, computed, createTextVNode, inject, provide } from 'vue';
    ...
    return {
        beforeCreate() {
            ...
            if (options.i18n) {
                ...
                const instance = getCurrentInstance();
                if (instance) {
                    legacyInstances.set(instance, createVueI18n({
...
export { Availabilities, VERSION, createI18n, useI18n };
