...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    // names here?
	    MotorHTMLScene: Object.assign({}, _nodeStyle2.default['MotorHTMLNode'], {
	        //display:   'block',
	        ...
	        _createClass(WebComponent, [{
	            ...
	            value: function _createStylesheet() {
	                ...
	                if (instanceCountByConstructor.get(this.constructor) === 1) {
	                    ...
	                    stylesheets.set(this.constructor, _jss2.default.createStyleSheet(this.getStyles()).attach());
	                }
	            }
	        }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _Utility.proxyGettersSetters)(_Transformable2.default, MotorHTMLNode);
	(0, _Utility.proxyGettersSetters)(_Sizeable2.default, MotorHTMLNode);
