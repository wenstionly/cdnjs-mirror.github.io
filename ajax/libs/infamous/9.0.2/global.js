	    ...
	    var Transformable = function (_Sizeable$mixin) {
	        ...
	        _createClass(Transformable, [{
	            ...
	            value: function value(obj) {
	                if (this !== Transformable) return _get(Object.getPrototypeOf(Transformable), Symbol.hasInstance, this).call(this, obj);
	...
	var SizeableMixin = function SizeableMixin(base) {
	    var Sizeable = function (_base) {
	        ...
	        _createClass(Sizeable, [{
	            ...
	            key: Symbol.hasInstance,
	            value: function value(obj) {
	                if (this !== Sizeable) return _get(Object.getPrototypeOf(Sizeable), Symbol.hasInstance, this).call(this, obj);
	    ...
	    var ImperativeBaseMixin = function ImperativeBaseMixin(base) {
	        var ImperativeBase = function (_TreeNode$mixin) {
	            ...
	            _createClass(ImperativeBase, [{
	                ...
	                key: Symbol.hasInstance,
	                value: function value(obj) {
	                    if (this !== ImperativeBase) return _get(Object.getPrototypeOf(ImperativeBase), Symbol.hasInstance, this).call(this, obj);
	...
	var TreeNodeMixin = function TreeNodeMixin(base) {
	    var TreeNode = function (_base) {
	        ...
	        _createClass(TreeNode, [{
	            ...
	            key: Symbol.hasInstance,
	            value: function value(obj) {
	                if (this !== TreeNode) return _get(Object.getPrototypeOf(TreeNode), Symbol.hasInstance, this).call(this, obj);
