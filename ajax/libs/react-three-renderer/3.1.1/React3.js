...
var React3 = (_temp = _class = function (_React$Component) {
  ...
  context: _ReactPropTypes2.default.string,
  ...
  canvasStyle: _ReactPropTypes2.default.any,
  /* eslint-enable react/forbid-prop-types */
  customRenderer: _ReactPropTypes2.default.func,
  gammaInput: _ReactPropTypes2.default.bool,
  gammaOutput: _ReactPropTypes2.default.bool,
  sortObjects: _ReactPropTypes2.default.bool,
  mainCamera: _ReactPropTypes2.default.string,
  onAnimate: _ReactPropTypes2.default.func,
  clearColor: _ReactPropTypes2.default.oneOfType([(0, _propTypeInstanceOf2.default)(THREE.Color), _ReactPropTypes2.default.number, _ReactPropTypes2.default.string]),
  shadowMapEnabled: _ReactPropTypes2.default.bool,
  shadowMapType: _ReactPropTypes2.default.oneOf([THREE.BasicShadowMap, THREE.PCFShadowMap, THREE.PCFSoftShadowMap]),
  shadowMapCullFace: _ReactPropTypes2.default.oneOf([THREE.CullFaceNone, THREE.CullFaceBack, THREE.CullFaceFront, THREE.CullFaceFrontBack]),
  shadowMapDebug: _ReactPropTypes2.default.bool,
  pixelRatio: _ReactPropTypes2.default.number,
  antialias: _ReactPropTypes2.default.oneOfType([_ReactPropTypes2.default.bool, _ReactPropTypes2.default.number]),
  canvasRef: _ReactPropTypes2.default.func
}, _class.defaultProps = {
  context: '3d'
