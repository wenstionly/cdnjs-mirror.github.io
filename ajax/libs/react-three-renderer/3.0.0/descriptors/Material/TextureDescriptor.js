...
var TextureDescriptor = (0, _resource2.default)(_class = function (_THREEElementDescript) {
  ...
  function TextureDescriptor(react3RendererInstance) {
    ...
    ['wrapS', 'wrapT'].forEach(function (propName) {
      _this.hasProp(propName, {
        type: _ReactPropTypes2.default.oneOf([THREE.RepeatWrapping, THREE.ClampToEdgeWrapping, THREE.MirroredRepeatWrapping]),
        updateInitial: true,
    ...
    _this.hasProp('magFilter', {
      type: _ReactPropTypes2.default.oneOf([THREE.LinearFilter, THREE.NearestFilter]),
    ...
    _this.hasProp('minFilter', {
      type: _ReactPropTypes2.default.oneOf([THREE.LinearMipMapLinearFilter, THREE.NearestFilter, THREE.NearestMipMapNearestFilter, THREE.NearestMipMapLinearFilter, THREE.LinearFilter, THREE.LinearMipMapNearestFilter]),
      update: function update(texture, magFilter) {
        texture.magFilter = magFilter;
        if (texture.image) {
          texture.needsUpdate = true;
  ...
  _createClass(TextureDescriptor, [{
    ...
    value: function setParent(texture, parentObject3D) {
      (0, _invariant2.default)(parentObject3D instanceof THREE.Material || parentObject3D instanceof _Uniform2.default, 'Parent is not a material or a uniform');
