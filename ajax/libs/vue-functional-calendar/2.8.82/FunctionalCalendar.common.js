...
// CONCATENATED MODULE: ./src/components/FunctionalCalendar.vue?vue&type=template&id=724ca198&
        ...
        calendar.weeks.forEach(function (week) {
          week.days.forEach(function (day) {
            ...
            if (vm.fConfigs.isDatePicker) {
              ...
              if (vm.calendar.hasOwnProperty('selectedDates') && vm.calendar.selectedDates.find(function (date) {
