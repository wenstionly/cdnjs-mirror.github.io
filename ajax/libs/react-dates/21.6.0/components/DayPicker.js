...
function (_ref) {
  ...
  _proto.renderNavigation = function renderNavigation(navDirection) {
    ...
    return _react["default"].createElement(_DayPickerNavigation["default"], {
      ...
      phrases: phrases,
      isRTL: isRTL,
      showNavNextButton: !(orientation === _constants.VERTICAL_SCROLLABLE && navDirection === PREV_NAV),
      showNavPrevButton: !(orientation === _constants.VERTICAL_SCROLLABLE && navDirection === NEXT_NAV)
    });
  };
