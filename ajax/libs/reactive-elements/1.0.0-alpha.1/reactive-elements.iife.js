var ReactiveElements = (function (React,ReactDOM) {
  'use strict';
  ...
  function reactiveElements(elementName, ReactComponent, options) {
    ...
    function create(parent, props) {
      ...
      return ReactDOM.render(element, getRenderRoot(parent, useShadowDom), props.onRender);
    }
...
//# sourceMappingURL=reactive-elements.iife.js.map
