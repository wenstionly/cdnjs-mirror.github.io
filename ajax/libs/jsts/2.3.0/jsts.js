...
(function (global, factory) {
  ...
  class GeometryCollectionIterator {
    ...
    next() {
      ...
      if (this._subcollectionIterator !== null) if (this._subcollectionIterator.hasNext()) {
  ...
  class PointLocator {
    ...
    locateOnLineString(p, l) {
      ...
      if (!l.isClosed()) if (p.equals(seq.getCoordinate(0)) || p.equals(seq.getCoordinate(seq.size() - 1))) {
    ...
    add() {
      if (arguments.length === 1) {
        ...
        for (let i = 0; i < 2; i++) for (let j = 1; j < 3; j++) {
          ...
          if (loc === Location.EXTERIOR || loc === Location.INTERIOR) if (this.isNull(i, j)) {
  ...
  class AbstractSTRtree {
    ...
    remove() {
      if (arguments.length === 2) {
        ...
        if (childToPrune !== null) if (childToPrune.getChildBoundables().isEmpty()) {
  ...
  class NodingValidator {
    ...
    checkInteriorIntersections() {
      if (arguments.length === 0) {
        ...
        if (this._li.hasIntersection()) if (this._li.isProper() || this.hasInteriorIntersection(this._li, p00, p01) || this.hasInteriorIntersection(this._li, p10, p11)) {
