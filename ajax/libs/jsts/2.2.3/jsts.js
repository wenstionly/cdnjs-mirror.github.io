...
(function (global, factory) {
  ...
  class Long {
    constructor(high, low) {
      _defineProperty(this, "high", 0);

      _defineProperty(this, "low", 0);
  ...
  class ArrayList extends List {
    constructor(o) {
      ...
      _defineProperty(this, "interfaces_", [List, Collection]);
    ...
    add(e) {
      if (arguments.length === 1) _classPrivateFieldGet(this, _array).push(e);else _classPrivateFieldGet(this, _array).splice(arguments[0], 0, arguments[1]);
      return true;
    }
    ...
    set(index, element) {
      const oldElement = _classPrivateFieldGet(this, _array)[index];

      _classPrivateFieldGet(this, _array)[index] = element;
      return oldElement;
    }
    ...
    get(index) {
      ...
      return _classPrivateFieldGet(this, _array)[index];
    }

    isEmpty() {
      return _classPrivateFieldGet(this, _array).length === 0;
    }
    ...
    toArray() {
      return _classPrivateFieldGet(this, _array).slice();
    }

    remove(o) {
      let found = false;

      for (let i = 0, len = _classPrivateFieldGet(this, _array).length; i < len; i++) {
        if (_classPrivateFieldGet(this, _array)[i] === o) {
          _classPrivateFieldGet(this, _array).splice(i, 1);
  ...
  class Iterator {
    constructor(arrayList) {
      ...
      _classPrivateFieldSet(this, _arrayList, arrayList);
    }

    next() {
      var _this$position;

      if (_classPrivateFieldGet(this, _position) === _classPrivateFieldGet(this, _arrayList).size()) throw new NoSuchElementException();
      return _classPrivateFieldGet(this, _arrayList).get((_classPrivateFieldSet(this, _position, (_this$position = +_classPrivateFieldGet(this, _position)) + 1), _this$position));
    }

    hasNext() {
      return _classPrivateFieldGet(this, _position) < _classPrivateFieldGet(this, _arrayList).size();
    } // TODO: should be in ListIterator


    set(element) {
      return _classPrivateFieldGet(this, _arrayList).set(_classPrivateFieldGet(this, _position) - 1, element);
    }

    remove() {
      _classPrivateFieldGet(this, _arrayList).remove(_classPrivateFieldGet(this, _arrayList).get(_classPrivateFieldGet(this, _position)));
    }

  }

  var _arrayList = new WeakMap();
  ...
  class Integer {
    ...
    compareTo(o) {
      if (_classPrivateFieldGet(this, _value) < o) return -1;
      if (_classPrivateFieldGet(this, _value) > o) return 1;
      return 0;
    }
  ...
  class Iterator$1 {
    constructor(hashSet) {
      ...
      _position$1.set(this, {
        writable: true,
        value: 0
      });

      _classPrivateFieldSet(this, _hashSet, hashSet);
    }

    next() {
      var _this$position;

      if (_classPrivateFieldGet(this, _position$1) === _classPrivateFieldGet(this, _hashSet).size()) throw new NoSuchElementException();
      return _classPrivateFieldGet(this, _hashSet).array_[(_classPrivateFieldSet(this, _position$1, (_this$position = +_classPrivateFieldGet(this, _position$1)) + 1), _this$position)];
    }

    hasNext() {
      if (_classPrivateFieldGet(this, _position$1) < _classPrivateFieldGet(this, _hashSet).size()) return true;else return false;
    }
  ...
  var _hashSet = new WeakMap();

  var _position$1 = new WeakMap();
  ...
  class TreeMap extends SortedMap {
    ...
    get(key) {
      let p = _classPrivateFieldGet(this, _root);

      while (p !== null) {
        let cmp = key.compareTo(p.key);
    ...
    put(key, value) {
      ...
      if (_classPrivateFieldGet(this, _root) === null) {
        ...
        _classPrivateFieldSet(this, _size, 1);

        return null;
      }

      let t = _classPrivateFieldGet(this, _root);
    ...
    fixAfterInsertion(x) {
      ...
      while (x != null && x !== _classPrivateFieldGet(this, _root) && x.parent.color === RED) {
      ...
      _classPrivateFieldGet(this, _root).color = BLACK;
    }
    ...
    rotateLeft(p) {
      if (p != null) {
        ...
        if (p.parent == null) {
          _classPrivateFieldSet(this, _root, r);
    ...
    rotateRight(p) {
      if (p != null) {
        ...
        if (p.parent == null) {
          _classPrivateFieldSet(this, _root, l);
  ...
  class Iterator$2 {
    constructor(treeSet) {
      ...
      _position$2.set(this, {
        writable: true,
        value: 0
      });

      _classPrivateFieldSet(this, _treeSet, treeSet);
    }

    next() {
      var _this$position;

      if (_classPrivateFieldGet(this, _position$2) === _classPrivateFieldGet(this, _treeSet).size()) throw new NoSuchElementException();
      return _classPrivateFieldGet(this, _treeSet).array_[(_classPrivateFieldSet(this, _position$2, (_this$position = +_classPrivateFieldGet(this, _position$2)) + 1), _this$position)];
    }

    hasNext() {
      return _classPrivateFieldGet(this, _position$2) < _classPrivateFieldGet(this, _treeSet).size();
    }
  ...
  var _treeSet = new WeakMap();

  var _position$2 = new WeakMap();
  ...
  class HashMap extends Map$1 {
    ...
    get(key) {
      return _classPrivateFieldGet(this, _map).get(key) || null;
    }

    put(key, value) {
      _classPrivateFieldGet(this, _map).set(key, value);
    ...
    values() {
      ...
      const it = _classPrivateFieldGet(this, _map).values();
    ...
    entrySet() {
      ...
      _classPrivateFieldGet(this, _map).entries().forEach(entry => hashSet.add(entry));

      return hashSet;
    }

    size() {
      return _classPrivateFieldGet(this, _map).size();
    }
  ...
  class Stack extends List {
    ...
    add(e) {
      _classPrivateFieldGet(this, _array$1).push(e);
    ...
    get(index) {
      if (index < 0 || index >= this.size()) throw new IndexOutOfBoundsException();
      return _classPrivateFieldGet(this, _array$1)[index];
    }
    /**
    ...
    pop(e) {
      if (_classPrivateFieldGet(this, _array$1).length === 0) throw new EmptyStackException();
      return _classPrivateFieldGet(this, _array$1).pop();
    }
    /**
    ...
    peek() {
      if (_classPrivateFieldGet(this, _array$1).length === 0) throw new EmptyStackException();
      return _classPrivateFieldGet(this, _array$1)[_classPrivateFieldGet(this, _array$1).length - 1];
    }
    /**
    ...
    empty() {
      return _classPrivateFieldGet(this, _array$1).length === 0;
    }
    /**
     * @return {boolean}
     */
    ...
    search(o) {
      return _classPrivateFieldGet(this, _array$1).indexOf(o);
    }
    /**
     * @return {number}
     */
    ...
    size() {
      return _classPrivateFieldGet(this, _array$1).length;
    }
    /**
     * @return {Array}
     */
    ...
    toArray() {
      return _classPrivateFieldGet(this, _array$1).slice();
    }

  }

  var _array$1 = new WeakMap();
  ...
  class LinkedList {
    ...
    addLast(e) {
      _classPrivateFieldGet(this, _array$2).push(e);
    }

    removeFirst() {
      return _classPrivateFieldGet(this, _array$2).shift();
    }

    isEmpty() {
      return _classPrivateFieldGet(this, _array$2).length === 0;
    }

  }

  var _array$2 = new WeakMap();
